...
export class ReservationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v24.services.ReservationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reservationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v24.services.ReservationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v24.services.ReservationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const reservationServiceStubMethods =
        ['quoteCampaigns', 'bookCampaigns'];
 ...
 */
  quoteCampaigns(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v24.services.IQuoteCampaignsRequest|undefined, {}|undefined
      ]>;
  quoteCampaigns(
      request: protos.google.ads.googleads.v24.services.IQuoteCampaignsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v24.services.IQuoteCampaignsResponse,
          protos.google.ads.googleads.v24.services.IQuoteCampaignsRequest|null|undefined,
          {}|null|undefined>): void;
  quoteCampaigns(
      request: protos.google.ads.googleads.v24.services.IQuoteCampaignsRequest,
      callback: Callback<
  ...
  quoteCampaigns(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.quoteCampaigns(request, options, wrappedCallback)
 ...
 */
  bookCampaigns(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v24.services.IBookCampaignsRequest|undefined, {}|undefined
      ]>;
  bookCampaigns(
      request: protos.google.ads.googleads.v24.services.IBookCampaignsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v24.services.IBookCampaignsResponse,
          protos.google.ads.googleads.v24.services.IBookCampaignsRequest|null|undefined,
          {}|null|undefined>): void;
  bookCampaigns(
      request: protos.google.ads.googleads.v24.services.IBookCampaignsRequest,
      callback: Callback<
  ...
  bookCampaigns(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.bookCampaigns(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.googleads.v24.services.IBookCampaignsResponse,
