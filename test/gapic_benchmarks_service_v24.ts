...
import * as benchmarksserviceModule from '../src';
...
describe('v24.BenchmarksServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = benchmarksserviceModule.v24.BenchmarksServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = benchmarksserviceModule.v24.BenchmarksServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new benchmarksserviceModule.v24.BenchmarksServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = benchmarksserviceModule.v24.BenchmarksServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.benchmarksServiceStub, undefined);
            await client.initialize();
            assert(client.benchmarksServiceStub);
        });
    ...
    describe('listBenchmarksAvailableDates', () => {
        it('invokes listBenchmarksAvailableDates without error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksAvailableDatesRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksAvailableDatesResponse()
            );
            client.innerApiCalls.listBenchmarksAvailableDates = stubSimpleCall(expectedResponse);
            const [response] = await client.listBenchmarksAvailableDates(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listBenchmarksAvailableDates without error using callback', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBenchmarksAvailableDates = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBenchmarksAvailableDates(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListBenchmarksAvailableDatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBenchmarksAvailableDates with error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBenchmarksAvailableDates = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBenchmarksAvailableDates(request), expectedError);
        });

        it('invokes listBenchmarksAvailableDates with closed client', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listBenchmarksLocations', () => {
        it('invokes listBenchmarksLocations without error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksLocationsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksLocationsResponse()
            );
            client.innerApiCalls.listBenchmarksLocations = stubSimpleCall(expectedResponse);
            const [response] = await client.listBenchmarksLocations(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listBenchmarksLocations without error using callback', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBenchmarksLocations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBenchmarksLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListBenchmarksLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBenchmarksLocations with error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBenchmarksLocations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBenchmarksLocations(request), expectedError);
        });

        it('invokes listBenchmarksLocations with closed client', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listBenchmarksProducts', () => {
        it('invokes listBenchmarksProducts without error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksProductsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksProductsResponse()
            );
            client.innerApiCalls.listBenchmarksProducts = stubSimpleCall(expectedResponse);
            const [response] = await client.listBenchmarksProducts(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listBenchmarksProducts without error using callback', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBenchmarksProducts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBenchmarksProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListBenchmarksProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBenchmarksProducts with error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBenchmarksProducts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBenchmarksProducts(request), expectedError);
        });

        it('invokes listBenchmarksProducts with closed client', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listBenchmarksSources', () => {
        it('invokes listBenchmarksSources without error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksSourcesRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListBenchmarksSourcesResponse()
            );
            client.innerApiCalls.listBenchmarksSources = stubSimpleCall(expectedResponse);
            const [response] = await client.listBenchmarksSources(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listBenchmarksSources without error using callback', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBenchmarksSources = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBenchmarksSources(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListBenchmarksSourcesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBenchmarksSources with error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBenchmarksSources = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBenchmarksSources(request), expectedError);
        });

        it('invokes listBenchmarksSources with closed client', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateBenchmarksMetrics', () => {
        it('invokes generateBenchmarksMetrics without error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateBenchmarksMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateBenchmarksMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateBenchmarksMetricsResponse()
            );
            client.innerApiCalls.generateBenchmarksMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateBenchmarksMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateBenchmarksMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateBenchmarksMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateBenchmarksMetrics without error using callback', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateBenchmarksMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateBenchmarksMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateBenchmarksMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateBenchmarksMetrics with error', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateBenchmarksMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateBenchmarksMetrics(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateBenchmarksMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateBenchmarksMetrics as SinonStub)
        ...
        it('invokes generateBenchmarksMetrics with closed client', async () => {
            const client = new benchmarksserviceModule.v24.BenchmarksServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
