...
describe('v24.KeywordPlanAdGroupKeywordServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient.port;
            assert(port);
    ...
    describe('mutateKeywordPlanAdGroupKeywords', () => {
        it('invokes mutateKeywordPlanAdGroupKeywords without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateKeywordPlanAdGroupKeywords as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateKeywordPlanAdGroupKeywords as SinonStub)
        ...
        it('invokes mutateKeywordPlanAdGroupKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroupKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateKeywordPlanAdGroupKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanAdGroupKeywords with closed client', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v24.KeywordPlanAdGroupKeywordServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
