...
describe('v19.KeywordThemeConstantServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordthemeconstantserviceModule.v19.KeywordThemeConstantServiceClient.port;
            assert(port);
    ...
    describe('suggestKeywordThemeConstants', () => {
        it('invokes suggestKeywordThemeConstants without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.SuggestKeywordThemeConstantsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.SuggestKeywordThemeConstantsResponse()
            );
        ...
        it('invokes suggestKeywordThemeConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemeConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.ISuggestKeywordThemeConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
