...
describe('v15.KeywordPlanAdGroupKeywordServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplanadgroupkeywordserviceModule.v15.KeywordPlanAdGroupKeywordServiceClient.port;
            assert(port);
    ...
    describe('mutateKeywordPlanAdGroupKeywords', () => {
        it('invokes mutateKeywordPlanAdGroupKeywords without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateKeywordPlanAdGroupKeywordsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateKeywordPlanAdGroupKeywordsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateKeywordPlanAdGroupKeywordsResponse()
            );
        ...
        it('invokes mutateKeywordPlanAdGroupKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroupKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateKeywordPlanAdGroupKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
