...
describe('v18.ContentCreatorInsightsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = contentcreatorinsightsserviceModule.v18.ContentCreatorInsightsServiceClient.port;
            assert(port);
    ...
    describe('generateCreatorInsights', () => {
        it('invokes generateCreatorInsights without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.GenerateCreatorInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.GenerateCreatorInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.GenerateCreatorInsightsResponse()
            );
        ...
        it('invokes generateCreatorInsights without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateCreatorInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.IGenerateCreatorInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
