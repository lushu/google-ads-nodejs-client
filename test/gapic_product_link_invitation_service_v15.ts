...
describe('v15.ProductLinkInvitationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = productlinkinvitationserviceModule.v15.ProductLinkInvitationServiceClient.port;
            assert(port);
    ...
    describe('updateProductLinkInvitation', () => {
        it('invokes updateProductLinkInvitation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.UpdateProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.UpdateProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.UpdateProductLinkInvitationResponse()
            );
        ...
        it('invokes updateProductLinkInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
