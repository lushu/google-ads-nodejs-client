...
import * as youtubevideouploadserviceModule from '../src';
...
describe('v24.YouTubeVideoUploadServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.youTubeVideoUploadServiceStub, undefined);
            await client.initialize();
            assert(client.youTubeVideoUploadServiceStub);
        });
    ...
    describe('createYouTubeVideoUpload', () => {
        it('invokes createYouTubeVideoUpload without error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.CreateYouTubeVideoUploadRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.CreateYouTubeVideoUploadRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.CreateYouTubeVideoUploadResponse()
            );
            client.innerApiCalls.createYouTubeVideoUpload = stubSimpleCall(expectedResponse);
            const [response] = await client.createYouTubeVideoUpload(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createYouTubeVideoUpload as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createYouTubeVideoUpload without error using callback', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createYouTubeVideoUpload = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createYouTubeVideoUpload(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ICreateYouTubeVideoUploadResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createYouTubeVideoUpload with error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createYouTubeVideoUpload = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createYouTubeVideoUpload(request), expectedError);
            const actualRequest = (client.innerApiCalls.createYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createYouTubeVideoUpload as SinonStub)
        ...
        it('invokes createYouTubeVideoUpload with closed client', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('updateYouTubeVideoUpload', () => {
        it('invokes updateYouTubeVideoUpload without error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.UpdateYouTubeVideoUploadRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.UpdateYouTubeVideoUploadRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.UpdateYouTubeVideoUploadResponse()
            );
            client.innerApiCalls.updateYouTubeVideoUpload = stubSimpleCall(expectedResponse);
            const [response] = await client.updateYouTubeVideoUpload(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateYouTubeVideoUpload as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateYouTubeVideoUpload without error using callback', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateYouTubeVideoUpload = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateYouTubeVideoUpload(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IUpdateYouTubeVideoUploadResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateYouTubeVideoUpload with error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateYouTubeVideoUpload = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateYouTubeVideoUpload(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateYouTubeVideoUpload as SinonStub)
        ...
        it('invokes updateYouTubeVideoUpload with closed client', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('removeYouTubeVideoUpload', () => {
        it('invokes removeYouTubeVideoUpload without error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveYouTubeVideoUploadRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.RemoveYouTubeVideoUploadRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveYouTubeVideoUploadResponse()
            );
            client.innerApiCalls.removeYouTubeVideoUpload = stubSimpleCall(expectedResponse);
            const [response] = await client.removeYouTubeVideoUpload(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeYouTubeVideoUpload as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes removeYouTubeVideoUpload without error using callback', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.removeYouTubeVideoUpload = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeYouTubeVideoUpload(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IRemoveYouTubeVideoUploadResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes removeYouTubeVideoUpload with error', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeYouTubeVideoUpload = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.removeYouTubeVideoUpload(request), expectedError);
            const actualRequest = (client.innerApiCalls.removeYouTubeVideoUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeYouTubeVideoUpload as SinonStub)
        ...
        it('invokes removeYouTubeVideoUpload with closed client', async () => {
            const client = new youtubevideouploadserviceModule.v24.YouTubeVideoUploadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
