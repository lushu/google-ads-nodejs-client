...
describe('v18.CustomerLabelServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerlabelserviceModule.v18.CustomerLabelServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerlabelserviceModule.v18.CustomerLabelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerlabelserviceModule.v18.CustomerLabelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerlabelserviceModule.v18.CustomerLabelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerlabelserviceModule.v18.CustomerLabelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customerlabelserviceModule.v18.CustomerLabelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerlabelserviceModule.v18.CustomerLabelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerlabelserviceModule.v18.CustomerLabelServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerLabels', () => {
        it('invokes mutateCustomerLabels without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateCustomerLabelsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.MutateCustomerLabelsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateCustomerLabelsResponse()
            );
        ...
        it('invokes mutateCustomerLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.IMutateCustomerLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
