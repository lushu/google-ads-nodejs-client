...
import * as localservicesleadserviceModule from '../src';
...
describe('v24.LocalServicesLeadServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = localservicesleadserviceModule.v24.LocalServicesLeadServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = localservicesleadserviceModule.v24.LocalServicesLeadServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = localservicesleadserviceModule.v24.LocalServicesLeadServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.localServicesLeadServiceStub, undefined);
            await client.initialize();
            assert(client.localServicesLeadServiceStub);
        });
    ...
    describe('appendLeadConversation', () => {
        it('invokes appendLeadConversation without error', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.AppendLeadConversationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.AppendLeadConversationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.AppendLeadConversationResponse()
            );
            client.innerApiCalls.appendLeadConversation = stubSimpleCall(expectedResponse);
            const [response] = await client.appendLeadConversation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.appendLeadConversation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.appendLeadConversation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes appendLeadConversation without error using callback', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.appendLeadConversation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.appendLeadConversation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IAppendLeadConversationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes appendLeadConversation with error', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.appendLeadConversation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.appendLeadConversation(request), expectedError);
            const actualRequest = (client.innerApiCalls.appendLeadConversation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.appendLeadConversation as SinonStub)
        ...
        it('invokes appendLeadConversation with closed client', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('provideLeadFeedback', () => {
        it('invokes provideLeadFeedback without error', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ProvideLeadFeedbackRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.ProvideLeadFeedbackRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ProvideLeadFeedbackResponse()
            );
            client.innerApiCalls.provideLeadFeedback = stubSimpleCall(expectedResponse);
            const [response] = await client.provideLeadFeedback(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.provideLeadFeedback as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.provideLeadFeedback as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes provideLeadFeedback without error using callback', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.provideLeadFeedback = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.provideLeadFeedback(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IProvideLeadFeedbackResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes provideLeadFeedback with error', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.provideLeadFeedback = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.provideLeadFeedback(request), expectedError);
            const actualRequest = (client.innerApiCalls.provideLeadFeedback as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.provideLeadFeedback as SinonStub)
        ...
        it('invokes provideLeadFeedback with closed client', async () => {
            const client = new localservicesleadserviceModule.v24.LocalServicesLeadServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
