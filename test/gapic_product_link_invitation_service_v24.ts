...
import * as productlinkinvitationserviceModule from '../src';
...
describe('v24.ProductLinkInvitationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.productLinkInvitationServiceStub, undefined);
            await client.initialize();
            assert(client.productLinkInvitationServiceStub);
        });
    ...
    describe('createProductLinkInvitation', () => {
        it('invokes createProductLinkInvitation without error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.CreateProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.CreateProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.CreateProductLinkInvitationResponse()
            );
            client.innerApiCalls.createProductLinkInvitation = stubSimpleCall(expectedResponse);
            const [response] = await client.createProductLinkInvitation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createProductLinkInvitation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createProductLinkInvitation without error using callback', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createProductLinkInvitation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ICreateProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createProductLinkInvitation with error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createProductLinkInvitation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createProductLinkInvitation(request), expectedError);
            const actualRequest = (client.innerApiCalls.createProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createProductLinkInvitation as SinonStub)
        ...
        it('invokes createProductLinkInvitation with closed client', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('updateProductLinkInvitation', () => {
        it('invokes updateProductLinkInvitation without error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.UpdateProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.UpdateProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.UpdateProductLinkInvitationResponse()
            );
            client.innerApiCalls.updateProductLinkInvitation = stubSimpleCall(expectedResponse);
            const [response] = await client.updateProductLinkInvitation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateProductLinkInvitation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateProductLinkInvitation without error using callback', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateProductLinkInvitation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IUpdateProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateProductLinkInvitation with error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateProductLinkInvitation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateProductLinkInvitation(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateProductLinkInvitation as SinonStub)
        ...
        it('invokes updateProductLinkInvitation with closed client', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('removeProductLinkInvitation', () => {
        it('invokes removeProductLinkInvitation without error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.RemoveProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveProductLinkInvitationResponse()
            );
            client.innerApiCalls.removeProductLinkInvitation = stubSimpleCall(expectedResponse);
            const [response] = await client.removeProductLinkInvitation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeProductLinkInvitation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes removeProductLinkInvitation without error using callback', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.removeProductLinkInvitation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IRemoveProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes removeProductLinkInvitation with error', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeProductLinkInvitation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.removeProductLinkInvitation(request), expectedError);
            const actualRequest = (client.innerApiCalls.removeProductLinkInvitation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeProductLinkInvitation as SinonStub)
        ...
        it('invokes removeProductLinkInvitation with closed client', async () => {
            const client = new productlinkinvitationserviceModule.v24.ProductLinkInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
