...
describe('v16.PaymentsAccountServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new paymentsaccountserviceModule.v16.PaymentsAccountServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = paymentsaccountserviceModule.v16.PaymentsAccountServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = paymentsaccountserviceModule.v16.PaymentsAccountServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new paymentsaccountserviceModule.v16.PaymentsAccountServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new paymentsaccountserviceModule.v16.PaymentsAccountServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new paymentsaccountserviceModule.v16.PaymentsAccountServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = paymentsaccountserviceModule.v16.PaymentsAccountServiceClient.port;
            assert(port);
    ...
    describe('listPaymentsAccounts', () => {
        it('invokes listPaymentsAccounts without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPaymentsAccountsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.ListPaymentsAccountsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPaymentsAccountsResponse()
            );
        ...
        it('invokes listPaymentsAccounts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPaymentsAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IListPaymentsAccountsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
