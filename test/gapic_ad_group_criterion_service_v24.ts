...
describe('v24.AdGroupCriterionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient.port;
            assert(port);
    ...
    describe('mutateAdGroupCriteria', () => {
        it('invokes mutateAdGroupCriteria without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateAdGroupCriteriaResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateAdGroupCriteria as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateAdGroupCriteria as SinonStub)
        ...
        it('invokes mutateAdGroupCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateAdGroupCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupCriteria with closed client', async () => {
            const client = new adgroupcriterionserviceModule.v24.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
