...
import * as campaigngoalconfigserviceModule from '../src';
...
describe('v24.CampaignGoalConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.campaignGoalConfigServiceStub, undefined);
            await client.initialize();
            assert(client.campaignGoalConfigServiceStub);
        });
    ...
    describe('mutateCampaignGoalConfigs', () => {
        it('invokes mutateCampaignGoalConfigs without error', async () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCampaignGoalConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateCampaignGoalConfigsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCampaignGoalConfigsResponse()
            );
            client.innerApiCalls.mutateCampaignGoalConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignGoalConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateCampaignGoalConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateCampaignGoalConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes mutateCampaignGoalConfigs without error using callback', async () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateCampaignGoalConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignGoalConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateCampaignGoalConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignGoalConfigs with error', async () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateCampaignGoalConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignGoalConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.mutateCampaignGoalConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateCampaignGoalConfigs as SinonStub)
        ...
        it('invokes mutateCampaignGoalConfigs with closed client', async () => {
            const client = new campaigngoalconfigserviceModule.v24.CampaignGoalConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
