...
describe('v20.CampaignLifecycleGoalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignlifecyclegoalserviceModule.v20.CampaignLifecycleGoalServiceClient.port;
            assert(port);
    ...
    describe('configureCampaignLifecycleGoals', () => {
        it('invokes configureCampaignLifecycleGoals without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsResponse()
            );
        ...
        it('invokes configureCampaignLifecycleGoals without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.configureCampaignLifecycleGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v20.services.IConfigureCampaignLifecycleGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
