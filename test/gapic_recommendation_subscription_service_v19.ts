...
describe('v19.RecommendationSubscriptionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = recommendationsubscriptionserviceModule.v19.RecommendationSubscriptionServiceClient.port;
            assert(port);
    ...
    describe('mutateRecommendationSubscription', () => {
        it('invokes mutateRecommendationSubscription without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateRecommendationSubscriptionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.MutateRecommendationSubscriptionRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateRecommendationSubscriptionResponse()
            );
        ...
        it('invokes mutateRecommendationSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateRecommendationSubscription(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IMutateRecommendationSubscriptionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
