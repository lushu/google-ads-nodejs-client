...
describe('v24.KeywordPlanIdeaServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient.port;
            assert(port);
    ...
    describe('generateKeywordHistoricalMetrics', () => {
        it('invokes generateKeywordHistoricalMetrics without error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateKeywordHistoricalMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateKeywordHistoricalMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateKeywordHistoricalMetricsResponse()
            );
            client.innerApiCalls.generateKeywordHistoricalMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateKeywordHistoricalMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateKeywordHistoricalMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateKeywordHistoricalMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateKeywordHistoricalMetrics without error using callback', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateKeywordHistoricalMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordHistoricalMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateKeywordHistoricalMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordHistoricalMetrics with error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateKeywordHistoricalMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateKeywordHistoricalMetrics(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateKeywordHistoricalMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateKeywordHistoricalMetrics as SinonStub)
        ...
        it('invokes generateKeywordHistoricalMetrics with closed client', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateAdGroupThemes', () => {
        it('invokes generateAdGroupThemes without error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAdGroupThemesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateAdGroupThemesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAdGroupThemesResponse()
            );
            client.innerApiCalls.generateAdGroupThemes = stubSimpleCall(expectedResponse);
            const [response] = await client.generateAdGroupThemes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateAdGroupThemes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAdGroupThemes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateAdGroupThemes without error using callback', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateAdGroupThemes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateAdGroupThemes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateAdGroupThemesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateAdGroupThemes with error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateAdGroupThemes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateAdGroupThemes(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateAdGroupThemes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAdGroupThemes as SinonStub)
        ...
        it('invokes generateAdGroupThemes with closed client', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateKeywordForecastMetrics', () => {
        it('invokes generateKeywordForecastMetrics without error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateKeywordForecastMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateKeywordForecastMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateKeywordForecastMetricsResponse()
            );
            client.innerApiCalls.generateKeywordForecastMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateKeywordForecastMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateKeywordForecastMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateKeywordForecastMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateKeywordForecastMetrics without error using callback', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateKeywordForecastMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordForecastMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateKeywordForecastMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordForecastMetrics with error', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateKeywordForecastMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateKeywordForecastMetrics(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateKeywordForecastMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateKeywordForecastMetrics as SinonStub)
        ...
        it('invokes generateKeywordForecastMetrics with closed client', async () => {
            const client = new keywordplanideaserviceModule.v24.KeywordPlanIdeaServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateKeywordIdeas', () => {
        it('invokes generateKeywordIdeas without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateKeywordIdeasRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateKeywordIdeasRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v24.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v24.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v24.services.GenerateKeywordIdeaResult()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateKeywordIdeas as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateKeywordIdeas as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateKeywordIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateKeywordIdeaResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordIdeasStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v24.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v24.services.GenerateKeywordIdeaResult) => {
        ...
        it('uses async iteration with generateKeywordIdeas without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v24.services.IGenerateKeywordIdeaResult[] = [];
