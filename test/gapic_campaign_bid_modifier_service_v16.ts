...
describe('v16.CampaignBidModifierServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignbidmodifierserviceModule.v16.CampaignBidModifierServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignBidModifiers', () => {
        it('invokes mutateCampaignBidModifiers without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCampaignBidModifiersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateCampaignBidModifiersRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCampaignBidModifiersResponse()
            );
        ...
        it('invokes mutateCampaignBidModifiers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateCampaignBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
