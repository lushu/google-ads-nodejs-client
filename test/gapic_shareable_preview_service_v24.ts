...
import * as shareablepreviewserviceModule from '../src';
...
describe('v24.ShareablePreviewServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = shareablepreviewserviceModule.v24.ShareablePreviewServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = shareablepreviewserviceModule.v24.ShareablePreviewServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = shareablepreviewserviceModule.v24.ShareablePreviewServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.shareablePreviewServiceStub, undefined);
            await client.initialize();
            assert(client.shareablePreviewServiceStub);
        });
    ...
    describe('generateShareablePreviews', () => {
        it('invokes generateShareablePreviews without error', async () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateShareablePreviewsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateShareablePreviewsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateShareablePreviewsResponse()
            );
            client.innerApiCalls.generateShareablePreviews = stubSimpleCall(expectedResponse);
            const [response] = await client.generateShareablePreviews(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateShareablePreviews as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateShareablePreviews as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateShareablePreviews without error using callback', async () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateShareablePreviews = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateShareablePreviews(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateShareablePreviewsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateShareablePreviews with error', async () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateShareablePreviews = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateShareablePreviews(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateShareablePreviews as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateShareablePreviews as SinonStub)
        ...
        it('invokes generateShareablePreviews with closed client', async () => {
            const client = new shareablepreviewserviceModule.v24.ShareablePreviewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
