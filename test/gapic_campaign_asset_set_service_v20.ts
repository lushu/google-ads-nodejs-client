...
describe('v20.CampaignAssetSetServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignassetsetserviceModule.v20.CampaignAssetSetServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignAssetSets', () => {
        it('invokes mutateCampaignAssetSets without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.MutateCampaignAssetSetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.MutateCampaignAssetSetsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.MutateCampaignAssetSetsResponse()
            );
        ...
        it('invokes mutateCampaignAssetSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssetSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v20.services.IMutateCampaignAssetSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
