...
describe('v15.AssetGroupListingGroupFilterServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = assetgrouplistinggroupfilterserviceModule.v15.AssetGroupListingGroupFilterServiceClient.port;
            assert(port);
    ...
    describe('mutateAssetGroupListingGroupFilters', () => {
        it('invokes mutateAssetGroupListingGroupFilters without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersResponse()
            );
        ...
        it('invokes mutateAssetGroupListingGroupFilters without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroupListingGroupFilters(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
