...
describe('v21.GoogleAdsFieldServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = googleadsfieldserviceModule.v21.GoogleAdsFieldServiceClient.port;
            assert(port);
    ...
    describe('getGoogleAdsField', () => {
        it('invokes getGoogleAdsField without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GetGoogleAdsFieldRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GetGoogleAdsFieldRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.resources.GoogleAdsField()
            );
        ...
        it('invokes getGoogleAdsField without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGoogleAdsField(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.resources.IGoogleAdsField|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchGoogleAdsFields', () => {
        it('invokes searchGoogleAdsFields without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.SearchGoogleAdsFieldsRequest()
            );const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v21.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v21.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v21.resources.GoogleAdsField()),
            ];
        ...
        it('invokes searchGoogleAdsFieldsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v21.resources.GoogleAdsField[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v21.resources.GoogleAdsField) => {
        ...
        it('uses async iteration with searchGoogleAdsFields without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v21.resources.IGoogleAdsField[] = [];
