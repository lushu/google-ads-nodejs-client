...
import * as customerlifecyclegoalserviceModule from '../src';
...
describe('v24.CustomerLifecycleGoalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.customerLifecycleGoalServiceStub, undefined);
            await client.initialize();
            assert(client.customerLifecycleGoalServiceStub);
        });
    ...
    describe('configureCustomerLifecycleGoals', () => {
        it('invokes configureCustomerLifecycleGoals without error', async () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ConfigureCustomerLifecycleGoalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.ConfigureCustomerLifecycleGoalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ConfigureCustomerLifecycleGoalsResponse()
            );
            client.innerApiCalls.configureCustomerLifecycleGoals = stubSimpleCall(expectedResponse);
            const [response] = await client.configureCustomerLifecycleGoals(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.configureCustomerLifecycleGoals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.configureCustomerLifecycleGoals as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes configureCustomerLifecycleGoals without error using callback', async () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.configureCustomerLifecycleGoals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.configureCustomerLifecycleGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IConfigureCustomerLifecycleGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes configureCustomerLifecycleGoals with error', async () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.configureCustomerLifecycleGoals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.configureCustomerLifecycleGoals(request), expectedError);
            const actualRequest = (client.innerApiCalls.configureCustomerLifecycleGoals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.configureCustomerLifecycleGoals as SinonStub)
        ...
        it('invokes configureCustomerLifecycleGoals with closed client', async () => {
            const client = new customerlifecyclegoalserviceModule.v24.CustomerLifecycleGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
