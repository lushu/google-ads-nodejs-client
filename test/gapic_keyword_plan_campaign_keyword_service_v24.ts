...
describe('v24.KeywordPlanCampaignKeywordServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient.port;
            assert(port);
    ...
    describe('mutateKeywordPlanCampaignKeywords', () => {
        it('invokes mutateKeywordPlanCampaignKeywords without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateKeywordPlanCampaignKeywords as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateKeywordPlanCampaignKeywords as SinonStub)
        ...
        it('invokes mutateKeywordPlanCampaignKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaignKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateKeywordPlanCampaignKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanCampaignKeywords with closed client', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v24.KeywordPlanCampaignKeywordServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
