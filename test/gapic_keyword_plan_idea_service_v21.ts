...
describe('v21.KeywordPlanIdeaServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplanideaserviceModule.v21.KeywordPlanIdeaServiceClient.port;
            assert(port);
    ...
    describe('generateKeywordHistoricalMetrics', () => {
        it('invokes generateKeywordHistoricalMetrics without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateKeywordHistoricalMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateKeywordHistoricalMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateKeywordHistoricalMetricsResponse()
            );
        ...
        it('invokes generateKeywordHistoricalMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordHistoricalMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateKeywordHistoricalMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateAdGroupThemes', () => {
        it('invokes generateAdGroupThemes without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAdGroupThemesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateAdGroupThemesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAdGroupThemesResponse()
            );
        ...
        it('invokes generateAdGroupThemes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateAdGroupThemes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateAdGroupThemesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateKeywordForecastMetrics', () => {
        it('invokes generateKeywordForecastMetrics without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateKeywordForecastMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateKeywordForecastMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateKeywordForecastMetricsResponse()
            );
        ...
        it('invokes generateKeywordForecastMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordForecastMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateKeywordForecastMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateKeywordIdeas', () => {
        it('invokes generateKeywordIdeas without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateKeywordIdeasRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateKeywordIdeasRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v21.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v21.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v21.services.GenerateKeywordIdeaResult()),
            ];
        ...
        it('invokes generateKeywordIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateKeywordIdeaResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordIdeasStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v21.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v21.services.GenerateKeywordIdeaResult) => {
        ...
        it('uses async iteration with generateKeywordIdeas without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v21.services.IGenerateKeywordIdeaResult[] = [];
