...
describe('v16.RecommendationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new recommendationserviceModule.v16.RecommendationServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = recommendationserviceModule.v16.RecommendationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = recommendationserviceModule.v16.RecommendationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new recommendationserviceModule.v16.RecommendationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new recommendationserviceModule.v16.RecommendationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new recommendationserviceModule.v16.RecommendationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = recommendationserviceModule.v16.RecommendationServiceClient.port;
            assert(port);
    ...
    describe('applyRecommendation', () => {
        it('invokes applyRecommendation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ApplyRecommendationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.ApplyRecommendationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ApplyRecommendationResponse()
            );
        ...
        it('invokes applyRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.applyRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IApplyRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('dismissRecommendation', () => {
        it('invokes dismissRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.DismissRecommendationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.DismissRecommendationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.DismissRecommendationResponse()
            );
        ...
        it('invokes dismissRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.dismissRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IDismissRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateRecommendations', () => {
        it('invokes generateRecommendations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.GenerateRecommendationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.GenerateRecommendationsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.GenerateRecommendationsResponse()
            );
        ...
        it('invokes generateRecommendations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateRecommendations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IGenerateRecommendationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
