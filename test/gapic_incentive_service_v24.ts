...
import * as incentiveserviceModule from '../src';
...
describe('v24.IncentiveServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = incentiveserviceModule.v24.IncentiveServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = incentiveserviceModule.v24.IncentiveServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new incentiveserviceModule.v24.IncentiveServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new incentiveserviceModule.v24.IncentiveServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = incentiveserviceModule.v24.IncentiveServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.incentiveServiceStub, undefined);
            await client.initialize();
            assert(client.incentiveServiceStub);
        });
    ...
    describe('fetchIncentive', () => {
        it('invokes fetchIncentive without error', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.FetchIncentiveRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.FetchIncentiveResponse()
            );
            client.innerApiCalls.fetchIncentive = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchIncentive(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes fetchIncentive without error using callback', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.fetchIncentive = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchIncentive(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IFetchIncentiveResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchIncentive with error', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.fetchIncentive = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchIncentive(request), expectedError);
        });

        it('invokes fetchIncentive with closed client', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('applyIncentive', () => {
        it('invokes applyIncentive without error', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ApplyIncentiveRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.ApplyIncentiveRequest', ['customerId']);
            request.customerId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.ApplyIncentiveRequest', ['selectedIncentiveId']);
            request.selectedIncentiveId = defaultValue2;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }&selected_incentive_id=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ApplyIncentiveResponse()
            );
            client.innerApiCalls.applyIncentive = stubSimpleCall(expectedResponse);
            const [response] = await client.applyIncentive(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.applyIncentive as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.applyIncentive as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes applyIncentive without error using callback', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.applyIncentive = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.applyIncentive(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IApplyIncentiveResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes applyIncentive with error', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }&selected_incentive_id=${defaultValue2 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.applyIncentive = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.applyIncentive(request), expectedError);
            const actualRequest = (client.innerApiCalls.applyIncentive as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.applyIncentive as SinonStub)
        ...
        it('invokes applyIncentive with closed client', async () => {
            const client = new incentiveserviceModule.v24.IncentiveServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
