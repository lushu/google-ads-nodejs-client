...
describe('v21.AutomaticallyCreatedAssetRemovalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = automaticallycreatedassetremovalserviceModule.v21.AutomaticallyCreatedAssetRemovalServiceClient.port;
            assert(port);
    ...
    describe('removeCampaignAutomaticallyCreatedAsset', () => {
        it('invokes removeCampaignAutomaticallyCreatedAsset without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetResponse()
            );
        ...
        it('invokes removeCampaignAutomaticallyCreatedAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeCampaignAutomaticallyCreatedAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IRemoveCampaignAutomaticallyCreatedAssetResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
