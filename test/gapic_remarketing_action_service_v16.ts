...
describe('v16.RemarketingActionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new remarketingactionserviceModule.v16.RemarketingActionServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = remarketingactionserviceModule.v16.RemarketingActionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = remarketingactionserviceModule.v16.RemarketingActionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new remarketingactionserviceModule.v16.RemarketingActionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new remarketingactionserviceModule.v16.RemarketingActionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new remarketingactionserviceModule.v16.RemarketingActionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = remarketingactionserviceModule.v16.RemarketingActionServiceClient.port;
            assert(port);
    ...
    describe('mutateRemarketingActions', () => {
        it('invokes mutateRemarketingActions without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateRemarketingActionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateRemarketingActionsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateRemarketingActionsResponse()
            );
        ...
        it('invokes mutateRemarketingActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateRemarketingActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateRemarketingActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
