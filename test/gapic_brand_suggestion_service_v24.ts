...
import * as brandsuggestionserviceModule from '../src';
...
describe('v24.BrandSuggestionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = brandsuggestionserviceModule.v24.BrandSuggestionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = brandsuggestionserviceModule.v24.BrandSuggestionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = brandsuggestionserviceModule.v24.BrandSuggestionServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.brandSuggestionServiceStub, undefined);
            await client.initialize();
            assert(client.brandSuggestionServiceStub);
        });
    ...
    describe('suggestBrands', () => {
        it('invokes suggestBrands without error', async () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestBrandsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.SuggestBrandsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestBrandsResponse()
            );
            client.innerApiCalls.suggestBrands = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestBrands(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestBrands as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestBrands as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes suggestBrands without error using callback', async () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.suggestBrands = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestBrands(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ISuggestBrandsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestBrands with error', async () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.suggestBrands = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.suggestBrands(request), expectedError);
            const actualRequest = (client.innerApiCalls.suggestBrands as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestBrands as SinonStub)
        ...
        it('invokes suggestBrands with closed client', async () => {
            const client = new brandsuggestionserviceModule.v24.BrandSuggestionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
