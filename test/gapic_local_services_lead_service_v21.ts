...
describe('v21.LocalServicesLeadServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new localservicesleadserviceModule.v21.LocalServicesLeadServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = localservicesleadserviceModule.v21.LocalServicesLeadServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = localservicesleadserviceModule.v21.LocalServicesLeadServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new localservicesleadserviceModule.v21.LocalServicesLeadServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new localservicesleadserviceModule.v21.LocalServicesLeadServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new localservicesleadserviceModule.v21.LocalServicesLeadServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new localservicesleadserviceModule.v21.LocalServicesLeadServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = localservicesleadserviceModule.v21.LocalServicesLeadServiceClient.port;
            assert(port);
    ...
    describe('appendLeadConversation', () => {
        it('invokes appendLeadConversation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.AppendLeadConversationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.AppendLeadConversationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.AppendLeadConversationResponse()
            );
        ...
        it('invokes appendLeadConversation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.appendLeadConversation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IAppendLeadConversationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('provideLeadFeedback', () => {
        it('invokes provideLeadFeedback without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ProvideLeadFeedbackRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.ProvideLeadFeedbackRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ProvideLeadFeedbackResponse()
            );
        ...
        it('invokes provideLeadFeedback without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.provideLeadFeedback(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IProvideLeadFeedbackResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
