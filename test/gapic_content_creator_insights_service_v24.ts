...
import * as contentcreatorinsightsserviceModule from '../src';
...
describe('v24.ContentCreatorInsightsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.contentCreatorInsightsServiceStub, undefined);
            await client.initialize();
            assert(client.contentCreatorInsightsServiceStub);
        });
    ...
    describe('generateCreatorInsights', () => {
        it('invokes generateCreatorInsights without error', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateCreatorInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateCreatorInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateCreatorInsightsResponse()
            );
            client.innerApiCalls.generateCreatorInsights = stubSimpleCall(expectedResponse);
            const [response] = await client.generateCreatorInsights(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateCreatorInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateCreatorInsights as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateCreatorInsights without error using callback', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateCreatorInsights = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateCreatorInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateCreatorInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateCreatorInsights with error', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateCreatorInsights = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateCreatorInsights(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateCreatorInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateCreatorInsights as SinonStub)
        ...
        it('invokes generateCreatorInsights with closed client', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateTrendingInsights', () => {
        it('invokes generateTrendingInsights without error', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateTrendingInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateTrendingInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateTrendingInsightsResponse()
            );
            client.innerApiCalls.generateTrendingInsights = stubSimpleCall(expectedResponse);
            const [response] = await client.generateTrendingInsights(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateTrendingInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateTrendingInsights as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateTrendingInsights without error using callback', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateTrendingInsights = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateTrendingInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateTrendingInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateTrendingInsights with error', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateTrendingInsights = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateTrendingInsights(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateTrendingInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateTrendingInsights as SinonStub)
        ...
        it('invokes generateTrendingInsights with closed client', async () => {
            const client = new contentcreatorinsightsserviceModule.v24.ContentCreatorInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
