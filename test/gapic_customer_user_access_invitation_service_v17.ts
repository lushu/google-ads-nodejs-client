...
describe('v17.CustomerUserAccessInvitationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customeruseraccessinvitationserviceModule.v17.CustomerUserAccessInvitationServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerUserAccessInvitation', () => {
        it('invokes mutateCustomerUserAccessInvitation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.MutateCustomerUserAccessInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.MutateCustomerUserAccessInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.MutateCustomerUserAccessInvitationResponse()
            );
        ...
        it('invokes mutateCustomerUserAccessInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.IMutateCustomerUserAccessInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
