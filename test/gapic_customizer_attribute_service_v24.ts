...
import * as customizerattributeserviceModule from '../src';
...
describe('v24.CustomizerAttributeServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customizerattributeserviceModule.v24.CustomizerAttributeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customizerattributeserviceModule.v24.CustomizerAttributeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customizerattributeserviceModule.v24.CustomizerAttributeServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.customizerAttributeServiceStub, undefined);
            await client.initialize();
            assert(client.customizerAttributeServiceStub);
        });
    ...
    describe('mutateCustomizerAttributes', () => {
        it('invokes mutateCustomizerAttributes without error', async () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCustomizerAttributesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateCustomizerAttributesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCustomizerAttributesResponse()
            );
            client.innerApiCalls.mutateCustomizerAttributes = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomizerAttributes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateCustomizerAttributes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateCustomizerAttributes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes mutateCustomizerAttributes without error using callback', async () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateCustomizerAttributes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomizerAttributes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateCustomizerAttributesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomizerAttributes with error', async () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateCustomizerAttributes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomizerAttributes(request), expectedError);
            const actualRequest = (client.innerApiCalls.mutateCustomizerAttributes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateCustomizerAttributes as SinonStub)
        ...
        it('invokes mutateCustomizerAttributes with closed client', async () => {
            const client = new customizerattributeserviceModule.v24.CustomizerAttributeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
