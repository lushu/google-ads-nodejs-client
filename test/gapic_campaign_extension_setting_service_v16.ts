...
describe('v16.CampaignExtensionSettingServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignextensionsettingserviceModule.v16.CampaignExtensionSettingServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignExtensionSettings', () => {
        it('invokes mutateCampaignExtensionSettings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCampaignExtensionSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateCampaignExtensionSettingsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCampaignExtensionSettingsResponse()
            );
        ...
        it('invokes mutateCampaignExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateCampaignExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
