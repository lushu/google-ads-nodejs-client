...
describe('v15.KeywordThemeConstantServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordthemeconstantserviceModule.v15.KeywordThemeConstantServiceClient.port;
            assert(port);
    ...
    describe('suggestKeywordThemeConstants', () => {
        it('invokes suggestKeywordThemeConstants without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.SuggestKeywordThemeConstantsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.SuggestKeywordThemeConstantsResponse()
            );
        ...
        it('invokes suggestKeywordThemeConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemeConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
