...
describe('v18.ExtensionFeedItemServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient.port;
            assert(port);
    ...
    describe('mutateExtensionFeedItems', () => {
        it('invokes mutateExtensionFeedItems without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateExtensionFeedItemsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.MutateExtensionFeedItemsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateExtensionFeedItemsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateExtensionFeedItems as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateExtensionFeedItems as SinonStub)
        ...
        it('invokes mutateExtensionFeedItems without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateExtensionFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.IMutateExtensionFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateExtensionFeedItems with closed client', async () => {
            const client = new extensionfeeditemserviceModule.v18.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
