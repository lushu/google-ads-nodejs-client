...
describe('v22.ProductLinkInvitationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = productlinkinvitationserviceModule.v22.ProductLinkInvitationServiceClient.port;
            assert(port);
    ...
    describe('createProductLinkInvitation', () => {
        it('invokes createProductLinkInvitation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.CreateProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v22.services.CreateProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.CreateProductLinkInvitationResponse()
            );
        ...
        it('invokes createProductLinkInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v22.services.ICreateProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateProductLinkInvitation', () => {
        it('invokes updateProductLinkInvitation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.UpdateProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v22.services.UpdateProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.UpdateProductLinkInvitationResponse()
            );
        ...
        it('invokes updateProductLinkInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v22.services.IUpdateProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeProductLinkInvitation', () => {
        it('invokes removeProductLinkInvitation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.RemoveProductLinkInvitationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v22.services.RemoveProductLinkInvitationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.RemoveProductLinkInvitationResponse()
            );
        ...
        it('invokes removeProductLinkInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeProductLinkInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v22.services.IRemoveProductLinkInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
