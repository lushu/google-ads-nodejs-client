...
describe('v21.AdGroupAdLabelServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adgroupadlabelserviceModule.v21.AdGroupAdLabelServiceClient.port;
            assert(port);
    ...
    describe('mutateAdGroupAdLabels', () => {
        it('invokes mutateAdGroupAdLabels without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateAdGroupAdLabelsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.MutateAdGroupAdLabelsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateAdGroupAdLabelsResponse()
            );
        ...
        it('invokes mutateAdGroupAdLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAdLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IMutateAdGroupAdLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
