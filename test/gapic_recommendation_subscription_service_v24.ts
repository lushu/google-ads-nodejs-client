...
import * as recommendationsubscriptionserviceModule from '../src';
...
describe('v24.RecommendationSubscriptionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.recommendationSubscriptionServiceStub, undefined);
            await client.initialize();
            assert(client.recommendationSubscriptionServiceStub);
        });
    ...
    describe('mutateRecommendationSubscription', () => {
        it('invokes mutateRecommendationSubscription without error', async () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateRecommendationSubscriptionResponse()
            );
            client.innerApiCalls.mutateRecommendationSubscription = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateRecommendationSubscription(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateRecommendationSubscription as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateRecommendationSubscription as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes mutateRecommendationSubscription without error using callback', async () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateRecommendationSubscription = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateRecommendationSubscription(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateRecommendationSubscriptionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateRecommendationSubscription with error', async () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateRecommendationSubscription = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateRecommendationSubscription(request), expectedError);
            const actualRequest = (client.innerApiCalls.mutateRecommendationSubscription as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateRecommendationSubscription as SinonStub)
        ...
        it('invokes mutateRecommendationSubscription with closed client', async () => {
            const client = new recommendationsubscriptionserviceModule.v24.RecommendationSubscriptionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
