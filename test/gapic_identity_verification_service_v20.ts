...
describe('v20.IdentityVerificationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new identityverificationserviceModule.v20.IdentityVerificationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = identityverificationserviceModule.v20.IdentityVerificationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = identityverificationserviceModule.v20.IdentityVerificationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new identityverificationserviceModule.v20.IdentityVerificationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new identityverificationserviceModule.v20.IdentityVerificationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new identityverificationserviceModule.v20.IdentityVerificationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new identityverificationserviceModule.v20.IdentityVerificationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = identityverificationserviceModule.v20.IdentityVerificationServiceClient.port;
            assert(port);
    ...
    describe('startIdentityVerification', () => {
        it('invokes startIdentityVerification without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.StartIdentityVerificationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.StartIdentityVerificationRequest', ['customerId']);
    ...
    describe('getIdentityVerification', () => {
        it('invokes getIdentityVerification without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.GetIdentityVerificationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.GetIdentityVerificationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.GetIdentityVerificationResponse()
            );
        ...
        it('invokes getIdentityVerification without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIdentityVerification(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v20.services.IGetIdentityVerificationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
