...
describe('v17.SmartCampaignSuggestServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = smartcampaignsuggestserviceModule.v17.SmartCampaignSuggestServiceClient.port;
            assert(port);
    ...
    describe('suggestSmartCampaignBudgetOptions', () => {
        it('invokes suggestSmartCampaignBudgetOptions without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestSmartCampaignBudgetOptionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.SuggestSmartCampaignBudgetOptionsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestSmartCampaignBudgetOptionsResponse()
            );
        ...
        it('invokes suggestSmartCampaignBudgetOptions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignBudgetOptions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.ISuggestSmartCampaignBudgetOptionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestSmartCampaignAd', () => {
        it('invokes suggestSmartCampaignAd without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestSmartCampaignAdRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.SuggestSmartCampaignAdRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestSmartCampaignAdResponse()
            );
        ...
        it('invokes suggestSmartCampaignAd without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.ISuggestSmartCampaignAdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestKeywordThemes', () => {
        it('invokes suggestKeywordThemes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestKeywordThemesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.SuggestKeywordThemesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.SuggestKeywordThemesResponse()
            );
        ...
        it('invokes suggestKeywordThemes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.ISuggestKeywordThemesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
