...
describe('v16.BillingSetupServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new billingsetupserviceModule.v16.BillingSetupServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = billingsetupserviceModule.v16.BillingSetupServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = billingsetupserviceModule.v16.BillingSetupServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new billingsetupserviceModule.v16.BillingSetupServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new billingsetupserviceModule.v16.BillingSetupServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new billingsetupserviceModule.v16.BillingSetupServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = billingsetupserviceModule.v16.BillingSetupServiceClient.port;
            assert(port);
    ...
    describe('mutateBillingSetup', () => {
        it('invokes mutateBillingSetup without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateBillingSetupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateBillingSetupRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateBillingSetupResponse()
            );
        ...
        it('invokes mutateBillingSetup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBillingSetup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateBillingSetupResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
