...
describe('v19.CampaignServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignserviceModule.v19.CampaignServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignserviceModule.v19.CampaignServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignserviceModule.v19.CampaignServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignserviceModule.v19.CampaignServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignserviceModule.v19.CampaignServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaignserviceModule.v19.CampaignServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignserviceModule.v19.CampaignServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignserviceModule.v19.CampaignServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaigns', () => {
        it('invokes mutateCampaigns without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateCampaignsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.MutateCampaignsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateCampaignsResponse()
            );
        ...
        it('invokes mutateCampaigns without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IMutateCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('enablePMaxBrandGuidelines', () => {
        it('invokes enablePMaxBrandGuidelines without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.EnablePMaxBrandGuidelinesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.EnablePMaxBrandGuidelinesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.EnablePMaxBrandGuidelinesResponse()
            );
        ...
        it('invokes enablePMaxBrandGuidelines without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.enablePMaxBrandGuidelines(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IEnablePMaxBrandGuidelinesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
