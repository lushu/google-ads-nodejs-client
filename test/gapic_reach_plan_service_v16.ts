...
describe('v16.ReachPlanServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new reachplanserviceModule.v16.ReachPlanServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reachplanserviceModule.v16.ReachPlanServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reachplanserviceModule.v16.ReachPlanServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reachplanserviceModule.v16.ReachPlanServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reachplanserviceModule.v16.ReachPlanServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reachplanserviceModule.v16.ReachPlanServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reachplanserviceModule.v16.ReachPlanServiceClient.port;
            assert(port);
    ...
    describe('listPlannableLocations', () => {
        it('invokes listPlannableLocations without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPlannableLocationsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPlannableLocationsResponse()
            );
        ...
        it('invokes listPlannableLocations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IListPlannableLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPlannableProducts', () => {
        it('invokes listPlannableProducts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPlannableProductsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListPlannableProductsResponse()
            );
        ...
        it('invokes listPlannableProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IListPlannableProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateReachForecast', () => {
        it('invokes generateReachForecast without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.GenerateReachForecastRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.GenerateReachForecastRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.GenerateReachForecastResponse()
            );
        ...
        it('invokes generateReachForecast without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateReachForecast(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IGenerateReachForecastResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
