...
describe('v22.CampaignGoalConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaigngoalconfigserviceModule.v22.CampaignGoalConfigServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignGoalConfigs', () => {
        it('invokes mutateCampaignGoalConfigs without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.MutateCampaignGoalConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v22.services.MutateCampaignGoalConfigsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.MutateCampaignGoalConfigsResponse()
            );
        ...
        it('invokes mutateCampaignGoalConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignGoalConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v22.services.IMutateCampaignGoalConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
