...
describe('v16.KeywordPlanCampaignKeywordServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = keywordplancampaignkeywordserviceModule.v16.KeywordPlanCampaignKeywordServiceClient.port;
            assert(port);
    ...
    describe('mutateKeywordPlanCampaignKeywords', () => {
        it('invokes mutateKeywordPlanCampaignKeywords without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateKeywordPlanCampaignKeywordsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateKeywordPlanCampaignKeywordsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateKeywordPlanCampaignKeywordsResponse()
            );
        ...
        it('invokes mutateKeywordPlanCampaignKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaignKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateKeywordPlanCampaignKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
