...
describe('v19.CampaignConversionGoalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignconversiongoalserviceModule.v19.CampaignConversionGoalServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignConversionGoals', () => {
        it('invokes mutateCampaignConversionGoals without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateCampaignConversionGoalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.MutateCampaignConversionGoalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateCampaignConversionGoalsResponse()
            );
        ...
        it('invokes mutateCampaignConversionGoals without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignConversionGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IMutateCampaignConversionGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
