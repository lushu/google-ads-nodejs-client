...
describe('v16.InvoiceServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new invoiceserviceModule.v16.InvoiceServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = invoiceserviceModule.v16.InvoiceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = invoiceserviceModule.v16.InvoiceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new invoiceserviceModule.v16.InvoiceServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new invoiceserviceModule.v16.InvoiceServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new invoiceserviceModule.v16.InvoiceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = invoiceserviceModule.v16.InvoiceServiceClient.port;
            assert(port);
    ...
    describe('listInvoices', () => {
        it('invokes listInvoices without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListInvoicesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.ListInvoicesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.ListInvoicesResponse()
            );
        ...
        it('invokes listInvoices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listInvoices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IListInvoicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
