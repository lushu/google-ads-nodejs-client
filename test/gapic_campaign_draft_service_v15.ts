...
describe('v15.CampaignDraftServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaigndraftserviceModule.v15.CampaignDraftServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaigndraftserviceModule.v15.CampaignDraftServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaigndraftserviceModule.v15.CampaignDraftServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaigndraftserviceModule.v15.CampaignDraftServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaigndraftserviceModule.v15.CampaignDraftServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaigndraftserviceModule.v15.CampaignDraftServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaigndraftserviceModule.v15.CampaignDraftServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignDrafts', () => {
        it('invokes mutateCampaignDrafts without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCampaignDraftsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateCampaignDraftsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCampaignDraftsResponse()
            );
        ...
        it('invokes mutateCampaignDrafts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignDrafts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateCampaignDraftsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('promoteCampaignDraft', () => {
        it('invokes promoteCampaignDraft without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.PromoteCampaignDraftRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.PromoteCampaignDraftRequest', ['campaignDraft']);
    ...
    describe('listCampaignDraftAsyncErrors', () => {
        it('invokes listCampaignDraftAsyncErrors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.ListCampaignDraftAsyncErrorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.ListCampaignDraftAsyncErrorsRequest', ['resourceName']);
