...
describe('v17.FeedMappingServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new feedmappingserviceModule.v17.FeedMappingServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = feedmappingserviceModule.v17.FeedMappingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = feedmappingserviceModule.v17.FeedMappingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new feedmappingserviceModule.v17.FeedMappingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new feedmappingserviceModule.v17.FeedMappingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new feedmappingserviceModule.v17.FeedMappingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new feedmappingserviceModule.v17.FeedMappingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = feedmappingserviceModule.v17.FeedMappingServiceClient.port;
            assert(port);
    ...
    describe('mutateFeedMappings', () => {
        it('invokes mutateFeedMappings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.MutateFeedMappingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.MutateFeedMappingsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.MutateFeedMappingsResponse()
            );
        ...
        it('invokes mutateFeedMappings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.IMutateFeedMappingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
