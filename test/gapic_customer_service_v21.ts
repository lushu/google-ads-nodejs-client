...
describe('v21.CustomerServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerserviceModule.v21.CustomerServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerserviceModule.v21.CustomerServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerserviceModule.v21.CustomerServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerserviceModule.v21.CustomerServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerserviceModule.v21.CustomerServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customerserviceModule.v21.CustomerServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerserviceModule.v21.CustomerServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerserviceModule.v21.CustomerServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomer', () => {
        it('invokes mutateCustomer without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateCustomerRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.MutateCustomerRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateCustomerResponse()
            );
        ...
        it('invokes mutateCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IMutateCustomerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAccessibleCustomers', () => {
        it('invokes listAccessibleCustomers without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListAccessibleCustomersRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListAccessibleCustomersResponse()
            );
        ...
        it('invokes listAccessibleCustomers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccessibleCustomers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IListAccessibleCustomersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCustomerClient', () => {
        it('invokes createCustomerClient without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.CreateCustomerClientRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.CreateCustomerClientRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.CreateCustomerClientResponse()
            );
        ...
        it('invokes createCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.ICreateCustomerClientResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
