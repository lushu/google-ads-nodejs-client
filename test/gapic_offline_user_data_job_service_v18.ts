...
describe('v18.OfflineUserDataJobServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = offlineuserdatajobserviceModule.v18.OfflineUserDataJobServiceClient.port;
            assert(port);
    ...
    describe('createOfflineUserDataJob', () => {
        it('invokes createOfflineUserDataJob without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.CreateOfflineUserDataJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.CreateOfflineUserDataJobRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.CreateOfflineUserDataJobResponse()
            );
        ...
        it('invokes createOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.ICreateOfflineUserDataJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addOfflineUserDataJobOperations', () => {
        it('invokes addOfflineUserDataJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.AddOfflineUserDataJobOperationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.AddOfflineUserDataJobOperationsRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.AddOfflineUserDataJobOperationsResponse()
            );
        ...
        it('invokes addOfflineUserDataJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addOfflineUserDataJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.IAddOfflineUserDataJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runOfflineUserDataJob', () => {
        it('invokes runOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.RunOfflineUserDataJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.RunOfflineUserDataJobRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes runOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runOfflineUserDataJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v18.resources.IOfflineUserDataJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v18.resources.IOfflineUserDataJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runOfflineUserDataJob as SinonStub)
                .getCall(0).args[0];
