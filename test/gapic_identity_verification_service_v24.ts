...
import * as identityverificationserviceModule from '../src';
...
describe('v24.IdentityVerificationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = identityverificationserviceModule.v24.IdentityVerificationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = identityverificationserviceModule.v24.IdentityVerificationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new identityverificationserviceModule.v24.IdentityVerificationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = identityverificationserviceModule.v24.IdentityVerificationServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.identityVerificationServiceStub, undefined);
            await client.initialize();
            assert(client.identityVerificationServiceStub);
        });
    ...
    describe('startIdentityVerification', () => {
        it('invokes startIdentityVerification without error', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.StartIdentityVerificationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.StartIdentityVerificationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.startIdentityVerification = stubSimpleCall(expectedResponse);
            const [response] = await client.startIdentityVerification(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startIdentityVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startIdentityVerification as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes startIdentityVerification without error using callback', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.startIdentityVerification = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes startIdentityVerification with error', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.startIdentityVerification = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.startIdentityVerification(request), expectedError);
            const actualRequest = (client.innerApiCalls.startIdentityVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startIdentityVerification as SinonStub)
        ...
        it('invokes startIdentityVerification with closed client', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getIdentityVerification', () => {
        it('invokes getIdentityVerification without error', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GetIdentityVerificationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GetIdentityVerificationRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GetIdentityVerificationResponse()
            );
            client.innerApiCalls.getIdentityVerification = stubSimpleCall(expectedResponse);
            const [response] = await client.getIdentityVerification(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getIdentityVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getIdentityVerification as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getIdentityVerification without error using callback', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getIdentityVerification = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getIdentityVerification(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGetIdentityVerificationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getIdentityVerification with error', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getIdentityVerification = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getIdentityVerification(request), expectedError);
            const actualRequest = (client.innerApiCalls.getIdentityVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getIdentityVerification as SinonStub)
        ...
        it('invokes getIdentityVerification with closed client', async () => {
            const client = new identityverificationserviceModule.v24.IdentityVerificationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
