...
describe('v16.TravelAssetSuggestionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = travelassetsuggestionserviceModule.v16.TravelAssetSuggestionServiceClient.port;
            assert(port);
    ...
    describe('suggestTravelAssets', () => {
        it('invokes suggestTravelAssets without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.SuggestTravelAssetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.SuggestTravelAssetsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.SuggestTravelAssetsResponse()
            );
        ...
        it('invokes suggestTravelAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestTravelAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.ISuggestTravelAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
