...
describe('v21.GeoTargetConstantServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = geotargetconstantserviceModule.v21.GeoTargetConstantServiceClient.port;
            assert(port);
    ...
    describe('suggestGeoTargetConstants', () => {
        it('invokes suggestGeoTargetConstants without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.SuggestGeoTargetConstantsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.SuggestGeoTargetConstantsResponse()
            );
        ...
        it('invokes suggestGeoTargetConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestGeoTargetConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.ISuggestGeoTargetConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
