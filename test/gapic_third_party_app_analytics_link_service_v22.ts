...
describe('v22.ThirdPartyAppAnalyticsLinkServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = thirdpartyappanalyticslinkserviceModule.v22.ThirdPartyAppAnalyticsLinkServiceClient.port;
            assert(port);
    ...
    describe('regenerateShareableLinkId', () => {
        it('invokes regenerateShareableLinkId without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.RegenerateShareableLinkIdRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v22.services.RegenerateShareableLinkIdRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v22.services.RegenerateShareableLinkIdResponse()
            );
        ...
        it('invokes regenerateShareableLinkId without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.regenerateShareableLinkId(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v22.services.IRegenerateShareableLinkIdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
