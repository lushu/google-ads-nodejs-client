...
import * as userlistcustomertypeserviceModule from '../src';
...
describe('v24.UserListCustomerTypeServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.userListCustomerTypeServiceStub, undefined);
            await client.initialize();
            assert(client.userListCustomerTypeServiceStub);
        });
    ...
    describe('mutateUserListCustomerTypes', () => {
        it('invokes mutateUserListCustomerTypes without error', async () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateUserListCustomerTypesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateUserListCustomerTypesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateUserListCustomerTypesResponse()
            );
            client.innerApiCalls.mutateUserListCustomerTypes = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateUserListCustomerTypes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateUserListCustomerTypes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateUserListCustomerTypes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes mutateUserListCustomerTypes without error using callback', async () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateUserListCustomerTypes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateUserListCustomerTypes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateUserListCustomerTypesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateUserListCustomerTypes with error', async () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateUserListCustomerTypes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateUserListCustomerTypes(request), expectedError);
            const actualRequest = (client.innerApiCalls.mutateUserListCustomerTypes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateUserListCustomerTypes as SinonStub)
        ...
        it('invokes mutateUserListCustomerTypes with closed client', async () => {
            const client = new userlistcustomertypeserviceModule.v24.UserListCustomerTypeServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
