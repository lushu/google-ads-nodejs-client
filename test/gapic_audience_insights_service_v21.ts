...
describe('v21.AudienceInsightsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new audienceinsightsserviceModule.v21.AudienceInsightsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = audienceinsightsserviceModule.v21.AudienceInsightsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = audienceinsightsserviceModule.v21.AudienceInsightsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new audienceinsightsserviceModule.v21.AudienceInsightsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new audienceinsightsserviceModule.v21.AudienceInsightsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new audienceinsightsserviceModule.v21.AudienceInsightsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new audienceinsightsserviceModule.v21.AudienceInsightsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = audienceinsightsserviceModule.v21.AudienceInsightsServiceClient.port;
            assert(port);
    ...
    describe('generateInsightsFinderReport', () => {
        it('invokes generateInsightsFinderReport without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateInsightsFinderReportRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateInsightsFinderReportRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateInsightsFinderReportResponse()
            );
        ...
        it('invokes generateInsightsFinderReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateInsightsFinderReport(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateInsightsFinderReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAudienceInsightsAttributes', () => {
        it('invokes listAudienceInsightsAttributes without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListAudienceInsightsAttributesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.ListAudienceInsightsAttributesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListAudienceInsightsAttributesResponse()
            );
        ...
        it('invokes listAudienceInsightsAttributes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAudienceInsightsAttributes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IListAudienceInsightsAttributesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listInsightsEligibleDates', () => {
        it('invokes listInsightsEligibleDates without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListInsightsEligibleDatesRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListInsightsEligibleDatesResponse()
            );
        ...
        it('invokes listInsightsEligibleDates without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listInsightsEligibleDates(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IListInsightsEligibleDatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateAudienceCompositionInsights', () => {
        it('invokes generateAudienceCompositionInsights without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAudienceCompositionInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateAudienceCompositionInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAudienceCompositionInsightsResponse()
            );
        ...
        it('invokes generateAudienceCompositionInsights without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateAudienceCompositionInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateAudienceCompositionInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateSuggestedTargetingInsights', () => {
        it('invokes generateSuggestedTargetingInsights without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateSuggestedTargetingInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateSuggestedTargetingInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateSuggestedTargetingInsightsResponse()
            );
        ...
        it('invokes generateSuggestedTargetingInsights without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateSuggestedTargetingInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateSuggestedTargetingInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateAudienceOverlapInsights', () => {
        it('invokes generateAudienceOverlapInsights without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAudienceOverlapInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateAudienceOverlapInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateAudienceOverlapInsightsResponse()
            );
        ...
        it('invokes generateAudienceOverlapInsights without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateAudienceOverlapInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateAudienceOverlapInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateTargetingSuggestionMetrics', () => {
        it('invokes generateTargetingSuggestionMetrics without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateTargetingSuggestionMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.GenerateTargetingSuggestionMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.GenerateTargetingSuggestionMetricsResponse()
            );
        ...
        it('invokes generateTargetingSuggestionMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateTargetingSuggestionMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IGenerateTargetingSuggestionMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
