...
describe('v18.CustomerSkAdNetworkConversionValueSchemaServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerskadnetworkconversionvalueschemaserviceModule.v18.CustomerSkAdNetworkConversionValueSchemaServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerSkAdNetworkConversionValueSchema', () => {
        it('invokes mutateCustomerSkAdNetworkConversionValueSchema without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse()
            );
        ...
        it('invokes mutateCustomerSkAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerSkAdNetworkConversionValueSchema(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v18.services.IMutateCustomerSkAdNetworkConversionValueSchemaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
