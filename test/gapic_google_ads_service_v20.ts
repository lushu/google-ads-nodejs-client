...
describe('v20.GoogleAdsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new googleadsserviceModule.v20.GoogleAdsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = googleadsserviceModule.v20.GoogleAdsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = googleadsserviceModule.v20.GoogleAdsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new googleadsserviceModule.v20.GoogleAdsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new googleadsserviceModule.v20.GoogleAdsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new googleadsserviceModule.v20.GoogleAdsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new googleadsserviceModule.v20.GoogleAdsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = googleadsserviceModule.v20.GoogleAdsServiceClient.port;
            assert(port);
    ...
    describe('mutate', () => {
        it('invokes mutate without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.MutateGoogleAdsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.MutateGoogleAdsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.MutateGoogleAdsResponse()
            );
        ...
        it('invokes mutate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutate(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v20.services.IMutateGoogleAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchStream', () => {
        it('invokes searchStream without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.SearchGoogleAdsStreamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.SearchGoogleAdsStreamRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.SearchGoogleAdsStreamResponse()
            );
            client.innerApiCalls.searchStream = stubServerStreamingCall(expectedResponse);
            const stream = client.searchStream(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.ads.googleads.v20.services.SearchGoogleAdsStreamResponse) => {
                    resolve(response);
                });
    ...
    describe('search', () => {
        it('invokes search without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v20.services.SearchGoogleAdsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v20.services.SearchGoogleAdsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v20.services.GoogleAdsRow()),
              generateSampleMessage(new protos.google.ads.googleads.v20.services.GoogleAdsRow()),
              generateSampleMessage(new protos.google.ads.googleads.v20.services.GoogleAdsRow()),
            ];
        ...
        it('invokes search without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.search(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v20.services.IGoogleAdsRow[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchStream1 without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v20.services.GoogleAdsRow[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v20.services.GoogleAdsRow) => {
        ...
        it('uses async iteration with search without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v20.services.IGoogleAdsRow[] = [];
