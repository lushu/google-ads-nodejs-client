...
describe('v16.AssetGroupAssetServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = assetgroupassetserviceModule.v16.AssetGroupAssetServiceClient.port;
            assert(port);
    ...
    describe('mutateAssetGroupAssets', () => {
        it('invokes mutateAssetGroupAssets without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateAssetGroupAssetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateAssetGroupAssetsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateAssetGroupAssetsResponse()
            );
        ...
        it('invokes mutateAssetGroupAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateAssetGroupAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
