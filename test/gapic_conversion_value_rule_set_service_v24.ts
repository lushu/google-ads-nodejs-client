...
describe('v24.ConversionValueRuleSetServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient.port;
            assert(port);
    ...
    describe('mutateConversionValueRuleSets', () => {
        it('invokes mutateConversionValueRuleSets without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateConversionValueRuleSetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateConversionValueRuleSetsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateConversionValueRuleSetsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateConversionValueRuleSets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateConversionValueRuleSets as SinonStub)
        ...
        it('invokes mutateConversionValueRuleSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionValueRuleSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateConversionValueRuleSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionValueRuleSets with closed client', async () => {
            const client = new conversionvaluerulesetserviceModule.v24.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
