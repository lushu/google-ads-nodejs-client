...
describe('v24.SmartCampaignSuggestServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient.port;
            assert(port);
    ...
    describe('suggestSmartCampaignBudgetOptions', () => {
        it('invokes suggestSmartCampaignBudgetOptions without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestSmartCampaignBudgetOptionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.SuggestSmartCampaignBudgetOptionsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestSmartCampaignBudgetOptionsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.suggestSmartCampaignBudgetOptions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestSmartCampaignBudgetOptions as SinonStub)
        ...
        it('invokes suggestSmartCampaignBudgetOptions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignBudgetOptions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ISuggestSmartCampaignBudgetOptionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestSmartCampaignBudgetOptions with closed client', async () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('suggestSmartCampaignAd', () => {
        it('invokes suggestSmartCampaignAd without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestSmartCampaignAdRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.SuggestSmartCampaignAdRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestSmartCampaignAdResponse()
            );
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestSmartCampaignAd as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestSmartCampaignAd as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes suggestSmartCampaignAd without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ISuggestSmartCampaignAdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestSmartCampaignAd with closed client', async () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('suggestKeywordThemes', () => {
        it('invokes suggestKeywordThemes without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestKeywordThemesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.SuggestKeywordThemesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.SuggestKeywordThemesResponse()
            );
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestKeywordThemes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestKeywordThemes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes suggestKeywordThemes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.ISuggestKeywordThemesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestKeywordThemes with closed client', async () => {
            const client = new smartcampaignsuggestserviceModule.v24.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
