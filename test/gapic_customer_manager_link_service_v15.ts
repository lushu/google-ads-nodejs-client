...
describe('v15.CustomerManagerLinkServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customermanagerlinkserviceModule.v15.CustomerManagerLinkServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerManagerLink', () => {
        it('invokes mutateCustomerManagerLink without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerManagerLinkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateCustomerManagerLinkRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerManagerLinkResponse()
            );
        ...
        it('invokes mutateCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateCustomerManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveManagerLink', () => {
        it('invokes moveManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MoveManagerLinkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MoveManagerLinkRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MoveManagerLinkResponse()
            );
        ...
        it('invokes moveManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMoveManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
