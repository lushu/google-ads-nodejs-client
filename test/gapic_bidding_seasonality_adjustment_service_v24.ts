...
describe('v24.BiddingSeasonalityAdjustmentServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = biddingseasonalityadjustmentserviceModule.v24.BiddingSeasonalityAdjustmentServiceClient.port;
            assert(port);
    ...
    describe('mutateBiddingSeasonalityAdjustments', () => {
        it('invokes mutateBiddingSeasonalityAdjustments without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResponse()
            );
        ...
        it('invokes mutateBiddingSeasonalityAdjustments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingSeasonalityAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateBiddingSeasonalityAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
