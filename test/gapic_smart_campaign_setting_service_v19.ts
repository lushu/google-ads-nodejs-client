...
describe('v19.SmartCampaignSettingServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = smartcampaignsettingserviceModule.v19.SmartCampaignSettingServiceClient.port;
            assert(port);
    ...
    describe('getSmartCampaignStatus', () => {
        it('invokes getSmartCampaignStatus without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.GetSmartCampaignStatusRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.GetSmartCampaignStatusRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.GetSmartCampaignStatusResponse()
            );
        ...
        it('invokes getSmartCampaignStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSmartCampaignStatus(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IGetSmartCampaignStatusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateSmartCampaignSettings', () => {
        it('invokes mutateSmartCampaignSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateSmartCampaignSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v19.services.MutateSmartCampaignSettingsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v19.services.MutateSmartCampaignSettingsResponse()
            );
        ...
        it('invokes mutateSmartCampaignSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateSmartCampaignSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v19.services.IMutateSmartCampaignSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
