...
describe('v16.ConversionCustomVariableServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversioncustomvariableserviceModule.v16.ConversionCustomVariableServiceClient.port;
            assert(port);
    ...
    describe('mutateConversionCustomVariables', () => {
        it('invokes mutateConversionCustomVariables without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateConversionCustomVariablesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateConversionCustomVariablesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateConversionCustomVariablesResponse()
            );
        ...
        it('invokes mutateConversionCustomVariables without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionCustomVariables(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateConversionCustomVariablesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
