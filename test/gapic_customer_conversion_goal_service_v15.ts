...
describe('v15.CustomerConversionGoalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerconversiongoalserviceModule.v15.CustomerConversionGoalServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerConversionGoals', () => {
        it('invokes mutateCustomerConversionGoals without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerConversionGoalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateCustomerConversionGoalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerConversionGoalsResponse()
            );
        ...
        it('invokes mutateCustomerConversionGoals without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerConversionGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
