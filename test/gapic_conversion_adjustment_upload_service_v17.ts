...
describe('v17.ConversionAdjustmentUploadServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversionadjustmentuploadserviceModule.v17.ConversionAdjustmentUploadServiceClient.port;
            assert(port);
    ...
    describe('uploadConversionAdjustments', () => {
        it('invokes uploadConversionAdjustments without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.UploadConversionAdjustmentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v17.services.UploadConversionAdjustmentsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v17.services.UploadConversionAdjustmentsResponse()
            );
        ...
        it('invokes uploadConversionAdjustments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadConversionAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v17.services.IUploadConversionAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
