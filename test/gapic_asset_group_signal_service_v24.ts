...
import * as assetgroupsignalserviceModule from '../src';
...
describe('v24.AssetGroupSignalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.assetGroupSignalServiceStub, undefined);
            await client.initialize();
            assert(client.assetGroupSignalServiceStub);
        });
    ...
    describe('mutateAssetGroupSignals', () => {
        it('invokes mutateAssetGroupSignals without error', async () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateAssetGroupSignalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateAssetGroupSignalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateAssetGroupSignalsResponse()
            );
            client.innerApiCalls.mutateAssetGroupSignals = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetGroupSignals(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateAssetGroupSignals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateAssetGroupSignals as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes mutateAssetGroupSignals without error using callback', async () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateAssetGroupSignals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroupSignals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateAssetGroupSignalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetGroupSignals with error', async () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.mutateAssetGroupSignals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetGroupSignals(request), expectedError);
            const actualRequest = (client.innerApiCalls.mutateAssetGroupSignals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateAssetGroupSignals as SinonStub)
        ...
        it('invokes mutateAssetGroupSignals with closed client', async () => {
            const client = new assetgroupsignalserviceModule.v24.AssetGroupSignalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
