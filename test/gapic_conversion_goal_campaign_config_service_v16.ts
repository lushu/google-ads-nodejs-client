...
describe('v16.ConversionGoalCampaignConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversiongoalcampaignconfigserviceModule.v16.ConversionGoalCampaignConfigServiceClient.port;
            assert(port);
    ...
    describe('mutateConversionGoalCampaignConfigs', () => {
        it('invokes mutateConversionGoalCampaignConfigs without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigsResponse()
            );
        ...
        it('invokes mutateConversionGoalCampaignConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionGoalCampaignConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateConversionGoalCampaignConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
