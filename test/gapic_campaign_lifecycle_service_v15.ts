...
import * as campaignlifecycleserviceModule from '../src';
...
describe('v15.CampaignLifecycleServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignlifecycleserviceModule.v15.CampaignLifecycleServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.campaignLifecycleServiceStub, undefined);
            await client.initialize();
            assert(client.campaignLifecycleServiceStub);
        });
    ...
    describe('configureCampaignLifecycleGoals', () => {
        it('invokes configureCampaignLifecycleGoals without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsResponse()
            );
        ...
        it('invokes configureCampaignLifecycleGoals without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.configureCampaignLifecycleGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
