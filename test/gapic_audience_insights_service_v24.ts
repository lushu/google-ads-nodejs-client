...
import * as audienceinsightsserviceModule from '../src';
...
describe('v24.AudienceInsightsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = audienceinsightsserviceModule.v24.AudienceInsightsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = audienceinsightsserviceModule.v24.AudienceInsightsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = audienceinsightsserviceModule.v24.AudienceInsightsServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.audienceInsightsServiceStub, undefined);
            await client.initialize();
            assert(client.audienceInsightsServiceStub);
        });
    ...
    describe('generateInsightsFinderReport', () => {
        it('invokes generateInsightsFinderReport without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateInsightsFinderReportRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateInsightsFinderReportRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateInsightsFinderReportResponse()
            );
            client.innerApiCalls.generateInsightsFinderReport = stubSimpleCall(expectedResponse);
            const [response] = await client.generateInsightsFinderReport(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateInsightsFinderReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateInsightsFinderReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateInsightsFinderReport without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateInsightsFinderReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateInsightsFinderReport(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateInsightsFinderReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateInsightsFinderReport with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateInsightsFinderReport = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateInsightsFinderReport(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateInsightsFinderReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateInsightsFinderReport as SinonStub)
        ...
        it('invokes generateInsightsFinderReport with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listAudienceInsightsAttributes', () => {
        it('invokes listAudienceInsightsAttributes without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListAudienceInsightsAttributesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.ListAudienceInsightsAttributesRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListAudienceInsightsAttributesResponse()
            );
            client.innerApiCalls.listAudienceInsightsAttributes = stubSimpleCall(expectedResponse);
            const [response] = await client.listAudienceInsightsAttributes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAudienceInsightsAttributes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAudienceInsightsAttributes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listAudienceInsightsAttributes without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listAudienceInsightsAttributes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAudienceInsightsAttributes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListAudienceInsightsAttributesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAudienceInsightsAttributes with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAudienceInsightsAttributes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAudienceInsightsAttributes(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAudienceInsightsAttributes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAudienceInsightsAttributes as SinonStub)
        ...
        it('invokes listAudienceInsightsAttributes with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listInsightsEligibleDates', () => {
        it('invokes listInsightsEligibleDates without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListInsightsEligibleDatesRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListInsightsEligibleDatesResponse()
            );
            client.innerApiCalls.listInsightsEligibleDates = stubSimpleCall(expectedResponse);
            const [response] = await client.listInsightsEligibleDates(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listInsightsEligibleDates without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listInsightsEligibleDates = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listInsightsEligibleDates(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListInsightsEligibleDatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listInsightsEligibleDates with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listInsightsEligibleDates = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listInsightsEligibleDates(request), expectedError);
        });

        it('invokes listInsightsEligibleDates with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateAudienceCompositionInsights', () => {
        it('invokes generateAudienceCompositionInsights without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceCompositionInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateAudienceCompositionInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceCompositionInsightsResponse()
            );
            client.innerApiCalls.generateAudienceCompositionInsights = stubSimpleCall(expectedResponse);
            const [response] = await client.generateAudienceCompositionInsights(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateAudienceCompositionInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceCompositionInsights as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateAudienceCompositionInsights without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateAudienceCompositionInsights = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateAudienceCompositionInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateAudienceCompositionInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateAudienceCompositionInsights with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateAudienceCompositionInsights = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateAudienceCompositionInsights(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateAudienceCompositionInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceCompositionInsights as SinonStub)
        ...
        it('invokes generateAudienceCompositionInsights with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateAudienceDefinition', () => {
        it('invokes generateAudienceDefinition without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceDefinitionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateAudienceDefinitionRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceDefinitionResponse()
            );
            client.innerApiCalls.generateAudienceDefinition = stubSimpleCall(expectedResponse);
            const [response] = await client.generateAudienceDefinition(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateAudienceDefinition as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceDefinition as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateAudienceDefinition without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateAudienceDefinition = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateAudienceDefinition(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateAudienceDefinitionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateAudienceDefinition with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateAudienceDefinition = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateAudienceDefinition(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateAudienceDefinition as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceDefinition as SinonStub)
        ...
        it('invokes generateAudienceDefinition with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateSuggestedTargetingInsights', () => {
        it('invokes generateSuggestedTargetingInsights without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateSuggestedTargetingInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateSuggestedTargetingInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateSuggestedTargetingInsightsResponse()
            );
            client.innerApiCalls.generateSuggestedTargetingInsights = stubSimpleCall(expectedResponse);
            const [response] = await client.generateSuggestedTargetingInsights(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateSuggestedTargetingInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateSuggestedTargetingInsights as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateSuggestedTargetingInsights without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateSuggestedTargetingInsights = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateSuggestedTargetingInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateSuggestedTargetingInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateSuggestedTargetingInsights with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateSuggestedTargetingInsights = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateSuggestedTargetingInsights(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateSuggestedTargetingInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateSuggestedTargetingInsights as SinonStub)
        ...
        it('invokes generateSuggestedTargetingInsights with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateAudienceOverlapInsights', () => {
        it('invokes generateAudienceOverlapInsights without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateAudienceOverlapInsightsResponse()
            );
            client.innerApiCalls.generateAudienceOverlapInsights = stubSimpleCall(expectedResponse);
            const [response] = await client.generateAudienceOverlapInsights(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateAudienceOverlapInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceOverlapInsights as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateAudienceOverlapInsights without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateAudienceOverlapInsights = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateAudienceOverlapInsights(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateAudienceOverlapInsightsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateAudienceOverlapInsights with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateAudienceOverlapInsights = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateAudienceOverlapInsights(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateAudienceOverlapInsights as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAudienceOverlapInsights as SinonStub)
        ...
        it('invokes generateAudienceOverlapInsights with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateTargetingSuggestionMetrics', () => {
        it('invokes generateTargetingSuggestionMetrics without error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateTargetingSuggestionMetricsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateTargetingSuggestionMetricsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateTargetingSuggestionMetricsResponse()
            );
            client.innerApiCalls.generateTargetingSuggestionMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateTargetingSuggestionMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateTargetingSuggestionMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateTargetingSuggestionMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes generateTargetingSuggestionMetrics without error using callback', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateTargetingSuggestionMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateTargetingSuggestionMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateTargetingSuggestionMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateTargetingSuggestionMetrics with error', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateTargetingSuggestionMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateTargetingSuggestionMetrics(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateTargetingSuggestionMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateTargetingSuggestionMetrics as SinonStub)
        ...
        it('invokes generateTargetingSuggestionMetrics with closed client', async () => {
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('Path templates', () => {
        ...
        describe('aiMaxSearchTermAdCombinationView', async () => {
            const fakePath = "/rendered/path/aiMaxSearchTermAdCombinationView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                ad_group_id: "adGroupIdValue",
            ...
            await client.initialize();
            client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('aiMaxSearchTermAdCombinationViewPath', () => {
                const result = client.aiMaxSearchTermAdCombinationViewPath("customerIdValue", "adGroupIdValue", "searchTermValue", "landingPageValue", "headlineValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromAiMaxSearchTermAdCombinationViewName', () => {
                const result = client.matchCustomerIdFromAiMaxSearchTermAdCombinationViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAdGroupIdFromAiMaxSearchTermAdCombinationViewName', () => {
                const result = client.matchAdGroupIdFromAiMaxSearchTermAdCombinationViewName(fakePath);
                assert.strictEqual(result, "adGroupIdValue");
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSearchTermFromAiMaxSearchTermAdCombinationViewName', () => {
                const result = client.matchSearchTermFromAiMaxSearchTermAdCombinationViewName(fakePath);
                assert.strictEqual(result, "searchTermValue");
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLandingPageFromAiMaxSearchTermAdCombinationViewName', () => {
                const result = client.matchLandingPageFromAiMaxSearchTermAdCombinationViewName(fakePath);
                assert.strictEqual(result, "landingPageValue");
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchHeadlineFromAiMaxSearchTermAdCombinationViewName', () => {
                const result = client.matchHeadlineFromAiMaxSearchTermAdCombinationViewName(fakePath);
                assert.strictEqual(result, "headlineValue");
                assert((client.pathTemplates.aiMaxSearchTermAdCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('appTopCombinationView', async () => {
            const fakePath = "/rendered/path/appTopCombinationView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                ad_group_id: "adGroupIdValue",
                ad_id: "adIdValue",
            ...
            await client.initialize();
            client.pathTemplates.appTopCombinationViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.appTopCombinationViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('appTopCombinationViewPath', () => {
                const result = client.appTopCombinationViewPath("customerIdValue", "adGroupIdValue", "adIdValue", "assetCombinationCategoryValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.appTopCombinationViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromAppTopCombinationViewName', () => {
                const result = client.matchCustomerIdFromAppTopCombinationViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.appTopCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAdGroupIdFromAppTopCombinationViewName', () => {
                const result = client.matchAdGroupIdFromAppTopCombinationViewName(fakePath);
                assert.strictEqual(result, "adGroupIdValue");
                assert((client.pathTemplates.appTopCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAdIdFromAppTopCombinationViewName', () => {
                const result = client.matchAdIdFromAppTopCombinationViewName(fakePath);
                assert.strictEqual(result, "adIdValue");
                assert((client.pathTemplates.appTopCombinationViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAssetCombinationCategoryFromAppTopCombinationViewName', () => {
                const result = client.matchAssetCombinationCategoryFromAppTopCombinationViewName(fakePath);
        ...
        describe('appliedIncentive', async () => {
            const fakePath = "/rendered/path/appliedIncentive";
            const expectedParameters = {
                customer_id: "customerIdValue",
            ...
            await client.initialize();
            client.pathTemplates.appliedIncentivePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.appliedIncentivePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('appliedIncentivePath', () => {
                const result = client.appliedIncentivePath("customerIdValue", "couponCodeValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.appliedIncentivePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromAppliedIncentiveName', () => {
                const result = client.matchCustomerIdFromAppliedIncentiveName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.appliedIncentivePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCouponCodeFromAppliedIncentiveName', () => {
                const result = client.matchCouponCodeFromAppliedIncentiveName(fakePath);
                assert.strictEqual(result, "couponCodeValue");
                assert((client.pathTemplates.appliedIncentivePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('campaignGoalConfig', async () => {
            const fakePath = "/rendered/path/campaignGoalConfig";
            const expectedParameters = {
                customer_id: "customerIdValue",
                campaign_id: "campaignIdValue",
                unified_goal_id: "unifiedGoalIdValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            await client.initialize();
            client.pathTemplates.campaignGoalConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.campaignGoalConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('campaignGoalConfigPath', () => {
                const result = client.campaignGoalConfigPath("customerIdValue", "campaignIdValue", "unifiedGoalIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.campaignGoalConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromCampaignGoalConfigName', () => {
                const result = client.matchCustomerIdFromCampaignGoalConfigName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.campaignGoalConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignIdFromCampaignGoalConfigName', () => {
                const result = client.matchCampaignIdFromCampaignGoalConfigName(fakePath);
                assert.strictEqual(result, "campaignIdValue");
                assert((client.pathTemplates.campaignGoalConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchUnifiedGoalIdFromCampaignGoalConfigName', () => {
                const result = client.matchUnifiedGoalIdFromCampaignGoalConfigName(fakePath);
                assert.strictEqual(result, "unifiedGoalIdValue");
                assert((client.pathTemplates.campaignGoalConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('campaignSearchTermView', async () => {
            const fakePath = "/rendered/path/campaignSearchTermView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                campaign_id: "campaignIdValue",
                query: "queryValue",
            ...
            await client.initialize();
            client.pathTemplates.campaignSearchTermViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.campaignSearchTermViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('campaignSearchTermViewPath', () => {
                const result = client.campaignSearchTermViewPath("customerIdValue", "campaignIdValue", "queryValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.campaignSearchTermViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromCampaignSearchTermViewName', () => {
                const result = client.matchCustomerIdFromCampaignSearchTermViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.campaignSearchTermViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignIdFromCampaignSearchTermViewName', () => {
                const result = client.matchCampaignIdFromCampaignSearchTermViewName(fakePath);
                assert.strictEqual(result, "campaignIdValue");
                assert((client.pathTemplates.campaignSearchTermViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchQueryFromCampaignSearchTermViewName', () => {
                const result = client.matchQueryFromCampaignSearchTermViewName(fakePath);
        ...
        describe('cartDataSalesView', async () => {
            const fakePath = "/rendered/path/cartDataSalesView";
            const expectedParameters = {
                customer_id: "customerIdValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
            ...
            await client.initialize();
            client.pathTemplates.cartDataSalesViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.cartDataSalesViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('cartDataSalesViewPath', () => {
                const result = client.cartDataSalesViewPath("customerIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.cartDataSalesViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromCartDataSalesViewName', () => {
                const result = client.matchCustomerIdFromCartDataSalesViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.cartDataSalesViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('contentCriterionView', async () => {
            ...
            it('contentCriterionViewPath', () => {
                const result = client.contentCriterionViewPath("customerIdValue", "adGroupIdValue", "criterionIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.contentCriterionViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromContentCriterionViewName', () => {
                const result = client.matchCustomerIdFromContentCriterionViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.contentCriterionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAdGroupIdFromContentCriterionViewName', () => {
                const result = client.matchAdGroupIdFromContentCriterionViewName(fakePath);
                assert.strictEqual(result, "adGroupIdValue");
                assert((client.pathTemplates.contentCriterionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCriterionIdFromContentCriterionViewName', () => {
                const result = client.matchCriterionIdFromContentCriterionViewName(fakePath);
                assert.strictEqual(result, "criterionIdValue");
                assert((client.pathTemplates.contentCriterionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('dataLink', async () => {
            ...
            it('dataLinkPath', () => {
                const result = client.dataLinkPath("customerIdValue", "productLinkIdValue", "dataLinkIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dataLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromDataLinkName', () => {
                const result = client.matchCustomerIdFromDataLinkName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.dataLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchProductLinkIdFromDataLinkName', () => {
                const result = client.matchProductLinkIdFromDataLinkName(fakePath);
                assert.strictEqual(result, "productLinkIdValue");
                assert((client.pathTemplates.dataLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchDataLinkIdFromDataLinkName', () => {
                const result = client.matchDataLinkIdFromDataLinkName(fakePath);
                assert.strictEqual(result, "dataLinkIdValue");
                assert((client.pathTemplates.dataLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });

        describe('detailContentSuitabilityPlacementView', async () => {
            const fakePath = "/rendered/path/detailContentSuitabilityPlacementView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                placement_fingerprint: "placementFingerprintValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            await client.initialize();
            client.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('detailContentSuitabilityPlacementViewPath', () => {
                const result = client.detailContentSuitabilityPlacementViewPath("customerIdValue", "placementFingerprintValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromDetailContentSuitabilityPlacementViewName', () => {
                const result = client.matchCustomerIdFromDetailContentSuitabilityPlacementViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchPlacementFingerprintFromDetailContentSuitabilityPlacementViewName', () => {
                const result = client.matchPlacementFingerprintFromDetailContentSuitabilityPlacementViewName(fakePath);
                assert.strictEqual(result, "placementFingerprintValue");
                assert((client.pathTemplates.detailContentSuitabilityPlacementViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('finalUrlExpansionAssetView', async () => {
            const fakePath = "/rendered/path/finalUrlExpansionAssetView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                campaign_id: "campaignIdValue",
                asset_id: "assetIdValue",
            ...
            await client.initialize();
            client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('finalUrlExpansionAssetViewPath', () => {
                const result = client.finalUrlExpansionAssetViewPath("customerIdValue", "campaignIdValue", "assetIdValue", "fieldTypeValue", "urlFpValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromFinalUrlExpansionAssetViewName', () => {
                const result = client.matchCustomerIdFromFinalUrlExpansionAssetViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignIdFromFinalUrlExpansionAssetViewName', () => {
                const result = client.matchCampaignIdFromFinalUrlExpansionAssetViewName(fakePath);
                assert.strictEqual(result, "campaignIdValue");
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAssetIdFromFinalUrlExpansionAssetViewName', () => {
                const result = client.matchAssetIdFromFinalUrlExpansionAssetViewName(fakePath);
                assert.strictEqual(result, "assetIdValue");
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFieldTypeFromFinalUrlExpansionAssetViewName', () => {
                const result = client.matchFieldTypeFromFinalUrlExpansionAssetViewName(fakePath);
                assert.strictEqual(result, "fieldTypeValue");
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchUrlFpFromFinalUrlExpansionAssetViewName', () => {
                const result = client.matchUrlFpFromFinalUrlExpansionAssetViewName(fakePath);
                assert.strictEqual(result, "urlFpValue");
                assert((client.pathTemplates.finalUrlExpansionAssetViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('goal', async () => {
            const fakePath = "/rendered/path/goal";
            const expectedParameters = {
                customer_id: "customerIdValue",
                unified_goal_id: "unifiedGoalIdValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.goalPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.goalPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('goalPath', () => {
                const result = client.goalPath("customerIdValue", "unifiedGoalIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.goalPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromGoalName', () => {
                const result = client.matchCustomerIdFromGoalName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.goalPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchUnifiedGoalIdFromGoalName', () => {
                const result = client.matchUnifiedGoalIdFromGoalName(fakePath);
                assert.strictEqual(result, "unifiedGoalIdValue");
                assert((client.pathTemplates.goalPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('groupContentSuitabilityPlacementView', async () => {
            const fakePath = "/rendered/path/groupContentSuitabilityPlacementView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                placement_fingerprint: "placementFingerprintValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('groupContentSuitabilityPlacementViewPath', () => {
                const result = client.groupContentSuitabilityPlacementViewPath("customerIdValue", "placementFingerprintValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromGroupContentSuitabilityPlacementViewName', () => {
                const result = client.matchCustomerIdFromGroupContentSuitabilityPlacementViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchPlacementFingerprintFromGroupContentSuitabilityPlacementViewName', () => {
                const result = client.matchPlacementFingerprintFromGroupContentSuitabilityPlacementViewName(fakePath);
                assert.strictEqual(result, "placementFingerprintValue");
                assert((client.pathTemplates.groupContentSuitabilityPlacementViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('locationInterestView', async () => {
            const fakePath = "/rendered/path/locationInterestView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                campaign_id: "campaignIdValue",
                ad_group_id: "adGroupIdValue",
            ...
            await client.initialize();
            client.pathTemplates.locationInterestViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.locationInterestViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('locationInterestViewPath', () => {
                const result = client.locationInterestViewPath("customerIdValue", "campaignIdValue", "adGroupIdValue", "criterionIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.locationInterestViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromLocationInterestViewName', () => {
                const result = client.matchCustomerIdFromLocationInterestViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.locationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignIdFromLocationInterestViewName', () => {
                const result = client.matchCampaignIdFromLocationInterestViewName(fakePath);
                assert.strictEqual(result, "campaignIdValue");
                assert((client.pathTemplates.locationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAdGroupIdFromLocationInterestViewName', () => {
                const result = client.matchAdGroupIdFromLocationInterestViewName(fakePath);
                assert.strictEqual(result, "adGroupIdValue");
                assert((client.pathTemplates.locationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCriterionIdFromLocationInterestViewName', () => {
                const result = client.matchCriterionIdFromLocationInterestViewName(fakePath);
                assert.strictEqual(result, "criterionIdValue");
                assert((client.pathTemplates.locationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('matchedLocationInterestView', async () => {
            const fakePath = "/rendered/path/matchedLocationInterestView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                country_criterion_id: "countryCriterionIdValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.matchedLocationInterestViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.matchedLocationInterestViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('matchedLocationInterestViewPath', () => {
                const result = client.matchedLocationInterestViewPath("customerIdValue", "countryCriterionIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.matchedLocationInterestViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromMatchedLocationInterestViewName', () => {
                const result = client.matchCustomerIdFromMatchedLocationInterestViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.matchedLocationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCountryCriterionIdFromMatchedLocationInterestViewName', () => {
                const result = client.matchCountryCriterionIdFromMatchedLocationInterestViewName(fakePath);
                assert.strictEqual(result, "countryCriterionIdValue");
                assert((client.pathTemplates.matchedLocationInterestViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('offlineConversionUploadConversionActionSummary', async () => {
            ...
            const expectedParameters = {
                customer_id: "customerIdValue",
                conversion_type_id: "conversionTypeIdValue",
                client: "clientValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
            ...
            it('offlineConversionUploadConversionActionSummaryPath', () => {
                const result = client.offlineConversionUploadConversionActionSummaryPath("customerIdValue", "conversionTypeIdValue", "clientValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromOfflineConversionUploadConversionActionSummaryName', () => {
                const result = client.matchCustomerIdFromOfflineConversionUploadConversionActionSummaryName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversionTypeIdFromOfflineConversionUploadConversionActionSummaryName', () => {
                const result = client.matchConversionTypeIdFromOfflineConversionUploadConversionActionSummaryName(fakePath);
                assert.strictEqual(result, "conversionTypeIdValue");
                assert((client.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchClientFromOfflineConversionUploadConversionActionSummaryName', () => {
                const result = client.matchClientFromOfflineConversionUploadConversionActionSummaryName(fakePath);
                assert.strictEqual(result, "clientValue");
                assert((client.pathTemplates.offlineConversionUploadConversionActionSummaryPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('performanceMaxPlacementView', async () => {
            ...
            it('performanceMaxPlacementViewPath', () => {
                const result = client.performanceMaxPlacementViewPath("customerIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.performanceMaxPlacementViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromPerformanceMaxPlacementViewName', () => {
                const result = client.matchCustomerIdFromPerformanceMaxPlacementViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.performanceMaxPlacementViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('targetingExpansionView', async () => {
            const fakePath = "/rendered/path/targetingExpansionView";
            const expectedParameters = {
                customer_id: "customerIdValue",
                campaign_id: "campaignIdValue",
                targeting_expansion_type: "targetingExpansionTypeValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            await client.initialize();
            client.pathTemplates.targetingExpansionViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.targetingExpansionViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('targetingExpansionViewPath', () => {
                const result = client.targetingExpansionViewPath("customerIdValue", "campaignIdValue", "targetingExpansionTypeValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.targetingExpansionViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromTargetingExpansionViewName', () => {
                const result = client.matchCustomerIdFromTargetingExpansionViewName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.targetingExpansionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignIdFromTargetingExpansionViewName', () => {
                const result = client.matchCampaignIdFromTargetingExpansionViewName(fakePath);
                assert.strictEqual(result, "campaignIdValue");
                assert((client.pathTemplates.targetingExpansionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchTargetingExpansionTypeFromTargetingExpansionViewName', () => {
                const result = client.matchTargetingExpansionTypeFromTargetingExpansionViewName(fakePath);
                assert.strictEqual(result, "targetingExpansionTypeValue");
                assert((client.pathTemplates.targetingExpansionViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('videoEnhancement', async () => {
            const fakePath = "/rendered/path/videoEnhancement";
            const expectedParameters = {
                customer_id: "customerIdValue",
                video_enhancement: "videoEnhancementValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            await client.initialize();
            client.pathTemplates.videoEnhancementPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.videoEnhancementPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('videoEnhancementPath', () => {
                const result = client.videoEnhancementPath("customerIdValue", "videoEnhancementValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.videoEnhancementPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromVideoEnhancementName', () => {
                const result = client.matchCustomerIdFromVideoEnhancementName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.videoEnhancementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchVideoEnhancementFromVideoEnhancementName', () => {
                const result = client.matchVideoEnhancementFromVideoEnhancementName(fakePath);
                assert.strictEqual(result, "videoEnhancementValue");
                assert((client.pathTemplates.videoEnhancementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('youTubeVideoUpload', async () => {
            const fakePath = "/rendered/path/youTubeVideoUpload";
            const expectedParameters = {
                customer_id: "customerIdValue",
                video_upload_id: "videoUploadIdValue",
            };
            const client = new audienceinsightsserviceModule.v24.AudienceInsightsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            await client.initialize();
            client.pathTemplates.youTubeVideoUploadPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.youTubeVideoUploadPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('youTubeVideoUploadPath', () => {
                const result = client.youTubeVideoUploadPath("customerIdValue", "videoUploadIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.youTubeVideoUploadPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerIdFromYouTubeVideoUploadName', () => {
                const result = client.matchCustomerIdFromYouTubeVideoUploadName(fakePath);
                assert.strictEqual(result, "customerIdValue");
                assert((client.pathTemplates.youTubeVideoUploadPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchVideoUploadIdFromYouTubeVideoUploadName', () => {
                const result = client.matchVideoUploadIdFromYouTubeVideoUploadName(fakePath);
                assert.strictEqual(result, "videoUploadIdValue");
                assert((client.pathTemplates.youTubeVideoUploadPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
