...
describe('v24.CampaignAssetSetServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient.port;
            assert(port);
    ...
    describe('mutateCampaignAssetSets', () => {
        it('invokes mutateCampaignAssetSets without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCampaignAssetSetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.MutateCampaignAssetSetsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.MutateCampaignAssetSetsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.mutateCampaignAssetSets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateCampaignAssetSets as SinonStub)
        ...
        it('invokes mutateCampaignAssetSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssetSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IMutateCampaignAssetSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignAssetSets with closed client', async () => {
            const client = new campaignassetsetserviceModule.v24.CampaignAssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
