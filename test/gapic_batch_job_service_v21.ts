...
describe('v21.BatchJobServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new batchjobserviceModule.v21.BatchJobServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = batchjobserviceModule.v21.BatchJobServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = batchjobserviceModule.v21.BatchJobServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new batchjobserviceModule.v21.BatchJobServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new batchjobserviceModule.v21.BatchJobServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new batchjobserviceModule.v21.BatchJobServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new batchjobserviceModule.v21.BatchJobServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = batchjobserviceModule.v21.BatchJobServiceClient.port;
            assert(port);
    ...
    describe('mutateBatchJob', () => {
        it('invokes mutateBatchJob without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateBatchJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.MutateBatchJobRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.MutateBatchJobResponse()
            );
        ...
        it('invokes mutateBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IMutateBatchJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addBatchJobOperations', () => {
        it('invokes addBatchJobOperations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.AddBatchJobOperationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.AddBatchJobOperationsRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.AddBatchJobOperationsResponse()
            );
        ...
        it('invokes addBatchJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addBatchJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IAddBatchJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runBatchJob', () => {
        it('invokes runBatchJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.RunBatchJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.RunBatchJobRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes runBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runBatchJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v21.resources.BatchJob.IBatchJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v21.resources.BatchJob.IBatchJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listBatchJobResults', () => {
        it('invokes listBatchJobResults without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v21.services.ListBatchJobResultsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v21.services.ListBatchJobResultsRequest', ['resourceName']);
            request.resourceName = defaultValue1;
            const expectedHeaderRequestParams = `resource_name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v21.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v21.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v21.services.BatchJobResult()),
            ];
        ...
        it('invokes listBatchJobResults without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listBatchJobResults(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v21.services.IBatchJobResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBatchJobResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v21.services.BatchJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v21.services.BatchJobResult) => {
        ...
        it('uses async iteration with listBatchJobResults without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v21.services.IBatchJobResult[] = [];
