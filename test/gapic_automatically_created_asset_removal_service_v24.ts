...
import * as automaticallycreatedassetremovalserviceModule from '../src';
...
describe('v24.AutomaticallyCreatedAssetRemovalServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.automaticallyCreatedAssetRemovalServiceStub, undefined);
            await client.initialize();
            assert(client.automaticallyCreatedAssetRemovalServiceStub);
        });
    ...
    describe('removeCampaignAutomaticallyCreatedAsset', () => {
        it('invokes removeCampaignAutomaticallyCreatedAsset without error', async () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveCampaignAutomaticallyCreatedAssetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.RemoveCampaignAutomaticallyCreatedAssetRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.RemoveCampaignAutomaticallyCreatedAssetResponse()
            );
            client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.removeCampaignAutomaticallyCreatedAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes removeCampaignAutomaticallyCreatedAsset without error using callback', async () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeCampaignAutomaticallyCreatedAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IRemoveCampaignAutomaticallyCreatedAssetResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes removeCampaignAutomaticallyCreatedAsset with error', async () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.removeCampaignAutomaticallyCreatedAsset(request), expectedError);
            const actualRequest = (client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeCampaignAutomaticallyCreatedAsset as SinonStub)
        ...
        it('invokes removeCampaignAutomaticallyCreatedAsset with closed client', async () => {
            const client = new automaticallycreatedassetremovalserviceModule.v24.AutomaticallyCreatedAssetRemovalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
