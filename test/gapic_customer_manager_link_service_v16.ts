...
describe('v16.CustomerManagerLinkServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customermanagerlinkserviceModule.v16.CustomerManagerLinkServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerManagerLink', () => {
        it('invokes mutateCustomerManagerLink without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCustomerManagerLinkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MutateCustomerManagerLinkRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MutateCustomerManagerLinkResponse()
            );
        ...
        it('invokes mutateCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMutateCustomerManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveManagerLink', () => {
        it('invokes moveManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MoveManagerLinkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v16.services.MoveManagerLinkRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v16.services.MoveManagerLinkResponse()
            );
        ...
        it('invokes moveManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v16.services.IMoveManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
