...
describe('v15.CustomerSkAdNetworkConversionValueSchemaServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customerskadnetworkconversionvalueschemaserviceModule.v15.CustomerSkAdNetworkConversionValueSchemaServiceClient.port;
            assert(port);
    ...
    describe('mutateCustomerSkAdNetworkConversionValueSchema', () => {
        it('invokes mutateCustomerSkAdNetworkConversionValueSchema without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse()
            );
        ...
        it('invokes mutateCustomerSkAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerSkAdNetworkConversionValueSchema(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
