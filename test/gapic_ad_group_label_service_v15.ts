...
describe('v15.AdGroupLabelServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new adgrouplabelserviceModule.v15.AdGroupLabelServiceClient();
        ...
        if (typeof process !== 'undefined' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adgrouplabelserviceModule.v15.AdGroupLabelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adgrouplabelserviceModule.v15.AdGroupLabelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adgrouplabelserviceModule.v15.AdGroupLabelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adgrouplabelserviceModule.v15.AdGroupLabelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adgrouplabelserviceModule.v15.AdGroupLabelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adgrouplabelserviceModule.v15.AdGroupLabelServiceClient.port;
            assert(port);
    ...
    describe('mutateAdGroupLabels', () => {
        it('invokes mutateAdGroupLabels without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateAdGroupLabelsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v15.services.MutateAdGroupLabelsRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v15.services.MutateAdGroupLabelsResponse()
            );
        ...
        it('invokes mutateAdGroupLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
