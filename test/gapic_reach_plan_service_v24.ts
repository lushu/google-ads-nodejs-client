...
describe('v24.ReachPlanServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reachplanserviceModule.v24.ReachPlanServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reachplanserviceModule.v24.ReachPlanServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'googleads.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'googleads.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reachplanserviceModule.v24.ReachPlanServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reachplanserviceModule.v24.ReachPlanServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reachplanserviceModule.v24.ReachPlanServiceClient.port;
            assert(port);
    ...
    describe('generateConversionRates', () => {
        it('invokes generateConversionRates without error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateConversionRatesRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateConversionRatesResponse()
            );
            client.innerApiCalls.generateConversionRates = stubSimpleCall(expectedResponse);
            const [response] = await client.generateConversionRates(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes generateConversionRates without error using callback', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateConversionRates = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateConversionRates(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateConversionRatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateConversionRates with error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateConversionRates = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateConversionRates(request), expectedError);
        });

        it('invokes generateConversionRates with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listPlannableLocations', () => {
        it('invokes listPlannableLocations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableLocationsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableLocationsResponse()
            );
        ...
        it('invokes listPlannableLocations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListPlannableLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listPlannableLocations with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listPlannableProducts', () => {
        it('invokes listPlannableProducts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableProductsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableProductsResponse()
            );
        ...
        it('invokes listPlannableProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListPlannableProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listPlannableProducts with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('generateReachForecast', () => {
        it('invokes generateReachForecast without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateReachForecastRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.googleads.v24.services.GenerateReachForecastRequest', ['customerId']);
            request.customerId = defaultValue1;
            const expectedHeaderRequestParams = `customer_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.GenerateReachForecastResponse()
            );
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateReachForecast as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateReachForecast as SinonStub)
        ...
        it('invokes generateReachForecast without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateReachForecast(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IGenerateReachForecastResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateReachForecast with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listPlannableUserLists', () => {
        it('invokes listPlannableUserLists without error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableUserListsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableUserListsResponse()
            );
            client.innerApiCalls.listPlannableUserLists = stubSimpleCall(expectedResponse);
            const [response] = await client.listPlannableUserLists(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listPlannableUserLists without error using callback', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listPlannableUserLists = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableUserLists(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListPlannableUserListsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listPlannableUserLists with error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPlannableUserLists = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPlannableUserLists(request), expectedError);
        });

        it('invokes listPlannableUserLists with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listPlannableUserInterests', () => {
        it('invokes listPlannableUserInterests without error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableUserInterestsRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.googleads.v24.services.ListPlannableUserInterestsResponse()
            );
            client.innerApiCalls.listPlannableUserInterests = stubSimpleCall(expectedResponse);
            const [response] = await client.listPlannableUserInterests(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes listPlannableUserInterests without error using callback', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listPlannableUserInterests = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableUserInterests(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v24.services.IListPlannableUserInterestsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listPlannableUserInterests with error', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPlannableUserInterests = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPlannableUserInterests(request), expectedError);
        });

        it('invokes listPlannableUserInterests with closed client', async () => {
            const client = new reachplanserviceModule.v24.ReachPlanServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
