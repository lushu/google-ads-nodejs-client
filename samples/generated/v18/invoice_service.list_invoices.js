...
function main(customerId, billingSetup, issueYear, issueMonth) {
  // [START googleads_v18_generated_InvoiceService_ListInvoices_async]
  /**
  ...
  const {InvoiceServiceClient} = require('google-ads').v18;
  ...
  callListInvoices();
  // [END googleads_v18_generated_InvoiceService_ListInvoices_async]
}
