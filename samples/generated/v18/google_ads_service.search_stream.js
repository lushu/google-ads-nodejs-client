...
function main(customerId, query) {
  // [START googleads_v18_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v18;
  ...
  callSearchStream();
  // [END googleads_v18_generated_GoogleAdsService_SearchStream_async]
}
