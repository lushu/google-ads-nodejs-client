...
function main(customerId, operations) {
  // [START googleads_v18_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v18;
  ...
  callMutateAssets();
  // [END googleads_v18_generated_AssetService_MutateAssets_async]
}
