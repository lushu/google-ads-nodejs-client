...
function main(customerId, operations) {
  // [START googleads_v18_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v18;
  ...
  callMutateLabels();
  // [END googleads_v18_generated_LabelService_MutateLabels_async]
}
