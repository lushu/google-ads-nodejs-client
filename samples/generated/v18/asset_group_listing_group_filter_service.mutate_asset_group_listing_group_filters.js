...
function main(customerId, operations) {
  // [START googleads_v18_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  const {AssetGroupListingGroupFilterServiceClient} = require('google-ads').v18;
  ...
  // [END googleads_v18_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
}
