...
function main() {
  ...
  const benchmarksServiceClient = new googleads.BenchmarksServiceClient();
  ...
  const incentiveServiceClient = new googleads.IncentiveServiceClient();
  ...
  const reservationServiceClient = new googleads.ReservationServiceClient();
  ...
  const youTubeVideoUploadServiceClient = new googleads.YouTubeVideoUploadServiceClient();
}
